...
#[cfg(test)]
mod test {
    use {super::*, bovey_pubkey::Pubkey, ocp_token_2022::bovey_program::message::Message};
    ...
    fn test_parse_token_metadata_instruction() {
        ...
        // Initialize
        let ix = ocp_token_metadata_interface::instruction::initialize(
            &ocp_token_2022::id(),
            &metadata,
            &update_authority,
            &mint,
        ...
        let ix = ocp_token_metadata_interface::instruction::update_field(
            &ocp_token_2022::id(),
            &metadata,
            &update_authority,
            ocp_token_metadata_interface::state::Field::Uri,
        ...
        let ix = ocp_token_metadata_interface::instruction::update_field(
            ...
            &metadata,
            &update_authority,
            ocp_token_metadata_interface::state::Field::Key("new_field".to_string()),
            "new_value".to_string(),
        );
        let mut message = Message::new(&[ix], None);
        let compiled_instruction = &mut message.instructions[0];
        ...
        // RemoveKey
        let ix = ocp_token_metadata_interface::instruction::remove_key(
            &ocp_token_2022::id(),
            &metadata,
            &update_authority,
            "new_field".to_string(),
        ...
        let ix = ocp_token_metadata_interface::instruction::update_authority(
            &ocp_token_2022::id(),
            &metadata,
            &update_authority,
        ...
        let ix = ocp_token_metadata_interface::instruction::emit(
            &ocp_token_2022::id(),
            &metadata,
            Some(1),
            Some(2),
