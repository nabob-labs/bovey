use {
    super::*,
    ocp_token_group_interface::instruction::{
...
mod test {
    ...
    fn test_parse_token_group_instruction() {
        ...
        let max_size = 300;
        let ix = ocp_token_group_interface::instruction::initialize_group(
            &ocp_token_2022::id(),
            &group_address,
            &group_mint,
        ...
        let ix = ocp_token_group_interface::instruction::update_group_max_size(
            &ocp_token_2022::id(),
            &group_address,
        ...
        let ix = ocp_token_group_interface::instruction::update_group_authority(
            &ocp_token_2022::id(),
            &group_address,
            &group_update_authority,
            Some(new_authority),
        ...
        // InitializeMember
        let ix = ocp_token_group_interface::instruction::initialize_member(
            &ocp_token_2022::id(),
            &member_address,
            &member_mint,
