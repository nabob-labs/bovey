use {
    ...
    ocp_token_2022::{
        ...
        bovey_zk_sdk::encryption::pod::elgamal::PodElGamalPubkey,
    },
};
        ...
        ConfidentialTransferInstruction::InitializeMint => {
            ...
            let initialize_mint_data: InitializeMintData =
                *decode_instruction_data(instruction_data).map_err(|_| {
                    ParseInstructionError::InstructionNotParsable(ParsableProgram::OcpToken)
                })?;
            let mut value = json!({
