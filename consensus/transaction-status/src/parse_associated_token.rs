use {
    ...
    bovey_pubkey::Pubkey,
    ocp_associated_token_account::instruction::AssociatedTokenAccountInstruction,
};

// A helper function to convert ocp_associated_token_account::id() as ocp_sdk::pubkey::Pubkey
// to bovey_pubkey::Pubkey
pub fn ocp_associated_token_id() -> Pubkey {
    Pubkey::new_from_array(ocp_associated_token_account::id().to_bytes())
}
...
pub fn parse_associated_token(
    ...
    let ata_instruction = if instruction.data.is_empty() {
        ...
        AssociatedTokenAccountInstruction::try_from_slice(&instruction.data)
            .map_err(|_| ParseInstructionError::InstructionNotParsable(ParsableProgram::OcpToken))?
    };
...
fn check_num_associated_token_accounts(
    ...
    check_num_accounts(accounts, num, ParsableProgram::OcpAssociatedTokenAccount)
}

#[cfg(test)]
mod test {
    #[allow(deprecated)]
    use ocp_associated_token_account::create_associated_token_account as create_associated_token_account_deprecated;
    use {
        super::*,
    ...
    fn test_parse_create_deprecated() {
        ...
        let expected_parsed_ix = ParsedInstructionEnum {
            ...
            info: json!({
                ...
                "tokenProgram": ocp_token::id().to_string(),
            }),
        };
        assert_eq!(
