use {
    ...
    bovey_program::address_lookup_table::instruction::ProgramInstruction,
};
...
mod test {
    use {
        super::*, bovey_message::Message, bovey_program::address_lookup_table::instruction,
        bovey_pubkey::Pubkey, bovey_sdk_ids::system_program, std::str::FromStr,
    };
