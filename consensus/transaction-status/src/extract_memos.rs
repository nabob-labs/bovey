...
// A helper function to convert ocp_memo::v1::id() as ocp_sdk::pubkey::Pubkey to
// bovey_pubkey::Pubkey
pub fn ocp_memo_id_v1() -> Pubkey {
    *MEMO_PROGRAM_ID_V1
}

// A helper function to convert ocp_memo::id() as ocp_sdk::pubkey::Pubkey to
// bovey_pubkey::Pubkey
pub fn ocp_memo_id_v3() -> Pubkey {
    *MEMO_PROGRAM_ID_V3
}

lazy_static! {
    static ref MEMO_PROGRAM_ID_V1: Pubkey = Pubkey::new_from_array(ocp_memo::v1::id().to_bytes());
    static ref MEMO_PROGRAM_ID_V3: Pubkey = Pubkey::new_from_array(ocp_memo::id().to_bytes());
}
