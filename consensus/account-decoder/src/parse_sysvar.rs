...
mod test {
    #[allow(deprecated)]
    use bovey_sysvar::recent_blockhashes::IterItem;
    use {
        super::*, bovey_account::create_account_for_test, bovey_fee_calculator::FeeCalculator,
        bovey_hash::Hash,
    };
    ...
    fn test_parse_sysvars() {
        ...
        let bad_pubkey = bovey_pubkey::new_rand();
