pub use bovey_account_decoder_client_types::token::{
...
use {
    crate::{
        parse_account_data::{
            ParsableAccount, ParseAccountError, OcpTokenAdditionalData, OcpTokenAdditionalDataV2,
        },
    ...
    ocp_token_2022::{
        ...
        bovey_program::{
            program_option::COption, program_pack::Pack, pubkey::Pubkey as OcpTokenPubkey,
        },
...
// Returns all known OCP Token program ids
pub fn ocp_token_ids() -> Vec<Pubkey> {
    vec![ocp_token::id(), ocp_token_2022::id()]
}

// Check if the provided program id as a known OCP Token program id
pub fn is_known_ocp_token_id(program_id: &Pubkey) -> bool {
    *program_id == ocp_token::id() || *program_id == ocp_token_2022::id()
}
...
pub fn parse_token(
    ...
    let additional_data = decimals.map(OcpTokenAdditionalData::with_decimals);
...
pub fn parse_token_v2(
    data: &[u8],
    additional_data: Option<&OcpTokenAdditionalData>,
) -> Result<TokenAccountType, ParseAccountError> {
...
pub fn parse_token_v3(
    ...
    if data.len() == Multisig::get_packed_len() {
        let multisig = Multisig::unpack(data)
            .map_err(|_| ParseAccountError::AccountNotParsable(ParsableAccount::OcpToken))?;
        Ok(TokenAccountType::Multisig(UiMultisig {
            ...
            signers: multisig
                ...
                .iter()
                .filter_map(|pubkey| {
                    if pubkey != &OcpTokenPubkey::default() {
...
pub fn token_amount_to_ui_amount(amount: u64, decimals: u8) -> UiTokenAmount {
    token_amount_to_ui_amount_v2(amount, &OcpTokenAdditionalData::with_decimals(decimals))
}

#[deprecated(since = "2.2.0", note = "Use `token_amount_to_ui_amount_v3` instead")]
pub fn token_amount_to_ui_amount_v2(
    amount: u64,
    additional_data: &OcpTokenAdditionalData,
) -> UiTokenAmount {
...
pub fn token_amount_to_ui_amount_v3(
    amount: u64,
    additional_data: &OcpTokenAdditionalDataV2,
) -> UiTokenAmount {
...
mod test {
    use {
        ...
        bovey_account_decoder_client_types::token::UiExtension,
        ocp_pod::optional_keys::OptionalNonZeroPubkey,
        ocp_token_2022::extension::{
    ...
    #[test]
    fn test_parse_token() {
        let mint_pubkey = OcpTokenPubkey::new_from_array([2; 32]);
        let owner_pubkey = OcpTokenPubkey::new_from_array([3; 32]);
        ...
        assert_eq!(
            parse_token_v3(
                &account_data,
                Some(&OcpTokenAdditionalDataV2::with_decimals(2))
            )
            .unwrap(),
        ...
        let signer1 = OcpTokenPubkey::new_from_array([1; 32]);
        let signer2 = OcpTokenPubkey::new_from_array([2; 32]);
        let signer3 = OcpTokenPubkey::new_from_array([3; 32]);
        let mut multisig_data = vec![0; Multisig::get_packed_len()];
        let mut signers = [OcpTokenPubkey::default(); 11];
        signers[0] = signer1;
        signers[1] = signer2;
        signers[2] = signer3;
    ...
    fn test_ui_token_amount_real_string() {
        ...
        let token_amount =
            token_amount_to_ui_amount_v3(1, &OcpTokenAdditionalDataV2::with_decimals(0));
        assert_eq!(
        ...
        let token_amount =
            token_amount_to_ui_amount_v3(10, &OcpTokenAdditionalDataV2::with_decimals(0));
        assert_eq!(
            token_amount.ui_amount_string,
        ...
        let token_amount =
            token_amount_to_ui_amount_v3(1, &OcpTokenAdditionalDataV2::with_decimals(9));
        assert_eq!(
            token_amount.ui_amount_string,
        ...
        let token_amount = token_amount_to_ui_amount_v3(
            1_000_000_000,
            &OcpTokenAdditionalDataV2::with_decimals(9),
        );
        assert_eq!(
            token_amount.ui_amount_string,
        ...
        let token_amount = token_amount_to_ui_amount_v3(
            1_234_567_890,
            &OcpTokenAdditionalDataV2::with_decimals(3),
        );
        assert_eq!(
            token_amount.ui_amount_string,
        ...
        let token_amount = token_amount_to_ui_amount_v3(
            1_234_567_890,
            &OcpTokenAdditionalDataV2::with_decimals(20),
        );
        assert_eq!(
            token_amount.ui_amount_string,
    ...
    fn test_ui_token_amount_real_string_zero() {
        ...
        let token_amount =
            token_amount_to_ui_amount_v3(0, &OcpTokenAdditionalDataV2::with_decimals(0));
        assert_eq!(
            token_amount.ui_amount_string,
        ...
        let token_amount =
            token_amount_to_ui_amount_v3(0, &OcpTokenAdditionalDataV2::with_decimals(9));
        assert_eq!(
            token_amount.ui_amount_string,
        ...
        let token_amount =
            token_amount_to_ui_amount_v3(0, &OcpTokenAdditionalDataV2::with_decimals(20));
        assert_eq!(
            token_amount.ui_amount_string,
