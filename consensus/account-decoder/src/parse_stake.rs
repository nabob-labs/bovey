use {
    ...
    bovey_program::stake::state::{Authorized, Delegation, Lockup, Meta, Stake, StakeStateV2},
};
...
pub struct UiDelegation {
    ...
    #[deprecated(
        since = "1.16.7",
        note = "Please use `bovey_program::stake::stake::warmup_cooldown_rate()` instead"
    )]
...
#[cfg(test)]
mod test {
    use {super::*, bincode::serialize, bovey_program::stake::stake_flags::StakeFlags};
