use {
    ...
    bincode::deserialize,
    serde_json::Value,
    ocp_config_program::{get_config_data, ConfigKeys},
    bovey_program::stake::config::{
...
#[deprecated(
    since = "1.16.7",
    note = "Please use `bovey_program::stake::state::warmup_cooldown_rate()` instead"
)]
#[derive(Debug, Serialize, Deserialize, PartialEq)]
#[serde(rename_all = "camelCase")]
...
mod test {
    use {
        ...
        bovey_account::ReadableAccount, ocp_config_program::create_config_account,
    };
    ...
    fn test_parse_config() {
        ...
        let info_pubkey = bovey_pubkey::new_rand();
        ...
        assert_eq!(
            ...
            ConfigAccountType::ValidatorInfo(UiConfig {
                ...
                config_data: serde_json::from_str(r#"{"name":"Bovey"}"#).unwrap(),
            }),
        );
