use {
    ...
    log::*,
    bovey_accounts_db::accounts_update_notifier_interface::AccountsUpdateNotifier,
    bovey_ledger::entry_notifier_interface::EntryNotifierArc,
    bovey_rpc::{
...
impl GeyserPluginService {
    ...
    fn start_manager_rpc_handler(
        ...
        thread::Builder::new()
            .name("BovGeyserPluginRpc".to_string())
            .spawn(move || loop {
