use {
    ...
    bovey_metrics::inc_new_counter_debug,
    bovey_perf::packet::{self, PacketBatch},
    bovey_rpc::{
...
mod tests {
    use {
        ...
        ocp_vote_program::vote_state::{TowerSync, Vote, MAX_LOCKOUT_HISTORY},
        std::{
    ...
    fn test_update_new_root() {
        ...
        let new_voter = bovey_pubkey::new_rand();
