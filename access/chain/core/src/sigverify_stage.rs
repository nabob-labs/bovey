...
use {
    ...
    bovey_sdk::timing,
    bovey_streamer::streamer::{self, StreamerError},
    std::{
...
impl SigVerifyStage {
    ...
    fn verifier<const K: usize, T: SigVerifier>(
        ...
        let non_discarded_packets = bovey_perf::discard::discard_batches_randomly(
            &mut batches,
            MAX_DEDUP_BATCH,
            num_packets,
        );
...
mod tests {
    ...
    fn test_sigverify_stage(use_same_tx: bool) {
        ...
        let stage = SigVerifyStage::new(packet_r, verifier, "bovSigVerTest", "test");
