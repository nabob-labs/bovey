...
use {
    ...
    bovey_ledger::blockstore::{Blockstore, CompletedDataSetInfo},
    bovey_rpc::{max_slots::MaxSlots, rpc_subscriptions::RpcSubscriptions},
    bovey_sdk::signature::Signature,
    std::{
        sync::{
...
impl CompletedDataSetsService {
    pub fn new(
        ...
        let thread_hdl = Builder::new()
            .name("bovComplDataSet".to_string())
            .spawn(move || {
