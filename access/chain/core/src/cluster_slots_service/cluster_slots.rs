use {
    ...
    bovey_runtime::{bank::Bank, epoch_stakes::NodeIdToVoteAccounts},
    bovey_sdk::{
...
#[cfg(test)]
mod tests {
    use {super::*, bovey_runtime::epoch_stakes::NodeVoteAccounts};
    ...
    fn test_best_peer_2() {
        ...
        let k1 = bovey_pubkey::new_rand();
        let k2 = bovey_pubkey::new_rand();
