use {ahash::AHashSet, bovey_pubkey::Pubkey, bovey_vm_transaction::vm_message::VMMessage};
...
impl ReadWriteAccountSet {
    ...
    pub fn check_locks(&self, message: &impl VMMessage) -> bool {
        message
            .account_keys()
            .iter()
            .enumerate()
    ...
    /// Returns true if all account locks were available and false otherwise.
    pub fn take_locks(&mut self, message: &impl VMMessage) -> bool {
        message
            .account_keys()
            .iter()
            .enumerate()
...
mod tests {
    use {
        ...
        bovey_ledger::genesis_utils::GenesisConfigInfo,
        bovey_runtime::{bank::Bank, bank_forks::BankForks, genesis_utils::create_genesis_config},
        bovey_sdk::{
