use {
    ...
    bovey_ledger::blockstore_processor::{ConfirmationProgress, ReplaySlotStats},
    bovey_runtime::{bank::Bank, bank_forks::BankForks},
    bovey_sdk::{clock::Slot, hash::Hash, pubkey::Pubkey},
...
#[cfg(test)]
mod test {
    use {super::*, bovey_vote::vote_account::VoteAccount};

    #[test]
    fn test_add_vote_pubkey() {
        let mut stats = PropagatedStats::default();
        let mut vote_pubkey = bovey_pubkey::new_rand();
        ...
        vote_pubkey = bovey_pubkey::new_rand();
    ...
    fn test_add_node_pubkey_internal() {
        ...
        let vote_account_pubkeys: Vec<_> = std::iter::repeat_with(bovey_pubkey::new_rand)
        ...
        let mut stats = PropagatedStats::default();
        let mut node_pubkey = bovey_pubkey::new_rand();
