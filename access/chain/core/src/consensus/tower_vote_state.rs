use {
    ...
    ocp_vote_program::vote_state::{Lockout, VoteState, VoteState1_14_11, MAX_LOCKOUT_HISTORY},
...
#[cfg(test)]
mod tests {
    use {super::*, ocp_vote_program::vote_state::INITIAL_LOCKOUT, std::collections::VecDeque};
