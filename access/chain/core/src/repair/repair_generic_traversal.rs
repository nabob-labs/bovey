use {
    ...
    bovey_ledger::{blockstore::Blockstore, blockstore_meta::SlotMeta},
    bovey_sdk::{clock::Slot, hash::Hash},
    ...
    fn add_tree_with_missing_shreds(
        ...
        while let Some(visit) = walk.get() {
            ...
            if parent.is_some() || !is_orphan {
                ...
                let entries = bovey_entry::entry::create_ticks(
                ...
                let mut shreds = bovey_ledger::blockstore::entries_to_test_shreds(
                    &entries,
                    slot,
