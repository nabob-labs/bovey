use {
    ...
    bovey_vm::transaction_commit_result::CommittedTransaction,
...
impl TransactionStatusService {
    pub fn new(
        ...
        let thread_hdl = Builder::new()
            .name("bovTxStatusWrtr".to_string())
            .spawn(move || {
...
pub(crate) mod tests {
    use {
        ...
        bovey_ledger::{genesis_utils::create_genesis_config, get_tmp_ledger_path_auto_delete},
        bovey_runtime::bank::{Bank, TransactionBalancesSet},
        bovey_sdk::{
        ...
        bovey_vm::transaction_execution_result::TransactionLoadedAccountsStats,
        bovey_transaction_status::{
    ...
    fn test_notify_transaction() {
        ...
        let pre_token_balance = TransactionTokenBalance {
            ...
            ui_token_amount: token_amount_to_ui_amount_v3(
                42,
                &OcpTokenAdditionalDataV2::with_decimals(2),
            ),
            owner: owner.clone(),
