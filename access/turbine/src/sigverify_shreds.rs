use {
    ...
    bovey_perf::{self, deduper::Deduper, packet::PacketBatch, recycler_cache::RecyclerCache},
    bovey_runtime::{
...
pub fn spawn_shred_sigverify(
    ...
    let thread_pool = ThreadPoolBuilder::new()
        ...
        .thread_name(|i| format!("bovSvrfyShred{i:02}"))
        .build()
...
fn verify_packets(
    ...
    bovey_perf::sigverify::mark_disabled(packets, &out);
}
