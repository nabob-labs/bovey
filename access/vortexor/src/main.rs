use {
    ...
    bovey_clap_utils::input_parsers::keypair_of,
    bovey_core::banking_trace::BankingTracer,
    bovey_sdk::net::DEFAULT_TPU_COALESCE,
...
pub fn main() {
    ...
    let cli_app = app(bovey_version, &default_args);
