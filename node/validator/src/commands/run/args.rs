use {
    ...
    bovey_ledger::use_snapshot_archives_at_startup,
    bovey_runtime::snapshot_utils::{SnapshotVersion, SUPPORTED_ARCHIVE_COMPRESSION},
...
pub fn add_args<'a>(app: App<'a, 'a>, default_args: &'a DefaultArgs) -> App<'a, 'a> {
    ...
    .arg(
        Arg::with_name("snapshot_packager_niceness_adj")
            ...
            .takes_value(true)
            .validator(bovey_perf::thread::is_niceness_adjustment_valid)
        ...
        Arg::with_name("staked_nodes_overrides")
            ...
            .help(
                "Provide path to a yaml file with custom overrides for stakes of specific \
                 ...
                 Format of the file: `staked_map_id: {<pubkey>: <BOV stake amount>}",
            ),
    )
    .arg(
    ...
    .arg(
        Arg::with_name("snapshot_archive_format")
            ...
            .alias("snapshot-compression") // Legacy name used by Bovey v1.5.x and older
