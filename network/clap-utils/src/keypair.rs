...
use {
    ...
    bovey_derivation_path::{DerivationPath, DerivationPathError},
    bovey_hash::Hash,
    bovey_keypair::{
    ...
    bovey_signer::{null_signer::NullSigner, Signer},
    std::{
        cell::RefCell,
        convert::TryFrom,
        error,
...
impl DefaultSigner {
    ...
    /// use bovey_clap_utils::keypair::DefaultSigner;
    /// use bovey_clap_utils::offline::OfflineArgs;
    ///
    ...
    /// ```no_run
    /// use clap::{App, Arg, value_t_or_exit};
    /// use bovey_clap_utils::keypair::{DefaultSigner, signer_from_path};
    /// use bovey_clap_utils::offline::OfflineArgs;
    ...
    /// ```no_run
    /// use clap::{App, Arg, value_t_or_exit};
    /// use bovey_clap_utils::keypair::{SignerFromPathConfig, DefaultSigner};
    /// use bovey_clap_utils::offline::OfflineArgs;
    ///
    /// let clap_app = App::new("my-program")
    ///     // The argument we'll parse as a signer "path"
...
/// ```no_run
/// use clap::{App, Arg, value_t_or_exit};
/// use bovey_clap_utils::keypair::signer_from_path;
/// use bovey_clap_utils::offline::OfflineArgs;
///
/// let clap_app = App::new("my-program")
///     // The argument we'll parse as a signer "path"
...
/// ```no_run
/// use clap::{App, Arg, value_t_or_exit};
/// use bovey_clap_utils::keypair::{signer_from_path_with_config, SignerFromPathConfig};
/// use bovey_clap_utils::offline::OfflineArgs;
///
/// let clap_app = App::new("my-program")
///     // The argument we'll parse as a signer "path"
...
/// ```no_run
/// use clap::{App, Arg, value_t_or_exit};
/// use bovey_clap_utils::keypair::pubkey_from_path;
///
/// let clap_app = App::new("my-program")
///     // The argument we'll parse as a signer "path"
///     .arg(Arg::with_name("keypair")
...
/// ```no_run
/// use clap::{App, Arg, value_t_or_exit};
/// use bovey_clap_utils::keypair::keypair_from_path;
///
/// let clap_app = App::new("my-program")
///     // The argument we'll parse as a signer "path"
///     .arg(Arg::with_name("keypair")
...
mod tests {
    use {
        ...
        bovey_remote_wallet::{locator::Manufacturer, remote_wallet::initialize_wallet_manager},
