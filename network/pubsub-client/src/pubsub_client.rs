...
//!
//! The [`PubsubClient`] implements [Bovey WebSocket event
//! subscriptions][spec].
//!
...
//! use bovey_pubsub_client::pubsub_client::PubsubClient;
//! use bovey_rpc_client_api::config::RpcAccountInfoConfig;
//! use std::thread;
//!
//! fn get_account_updates(account_pubkey: Pubkey) -> Result<()> {
//!     let url = "wss://api.devnet.bovey.com/";
//!
...
//! }
//! #
//! # get_account_updates(bovey_pubkey::new_rand());
//! # Ok::<(), anyhow::Error>(())
//! ```
...
use {
    ...
    bovey_account_decoder_client_types::UiAccount,
    bovey_clock::Slot,
    bovey_pubkey::Pubkey,
