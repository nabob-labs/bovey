pub use bovey_client::connection_cache::Protocol;
use {
    ...
    bovey_serde_varint as serde_varint, bovey_short_vec as short_vec,
...
impl ContactInfo {
    pub fn new(pubkey: Pubkey, wallclock: u64, shred_version: u16) -> Self {
        Self {
            ...
            shred_version,
            version: bovey_version::Version::default(),
    ...
    #[inline]
    pub(crate) fn version(&self) -> &bovey_version::Version {
        &self.version
    }
    ...
    pub fn new_rand<R: rand::Rng>(rng: &mut R, pubkey: Option<Pubkey>) -> Self {
        ...
        let now = bovey_sdk::timing::timestamp() - delay + rng.gen_range(0..2 * delay);
        let pubkey = pubkey.unwrap_or_else(bovey_pubkey::new_rand);
...
impl bovey_frozen_abi::abi_example::AbiExample for ContactInfo {
    fn example() -> Self {
        Self {
            ...
            version: bovey_version::Version::example(),
