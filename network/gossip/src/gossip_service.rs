...
pub fn discover(
    ...
    let _ip_echo_server = ip_echo.map(|tcp_listener| {
        bovey_net_utils::ip_echo_server(
            tcp_listener,
...
mod tests {
    ...
    fn test_gossip_services_spy() {
        ...
        let peer0 = bovey_pubkey::new_rand();
        let peer1 = bovey_pubkey::new_rand();
