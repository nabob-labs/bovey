...
use {
    ...
    serde::Serialize,
    serde_json::Value,
    bovey_account::{Account, ReadableAccount},
    bovey_account_decoder_client_types::token::{UiTokenAccount, UiTokenAmount},
    bovey_clock::{Epoch, Slot, UnixTimestamp},
    bovey_commitment_config::CommitmentConfig,
    bovey_epoch_info::EpochInfo,
    bovey_epoch_schedule::EpochSchedule,
    bovey_feature_gate_interface::Feature,
    bovey_hash::Hash,
    bovey_message::{v0, Message as LegacyMessage},
    bovey_pubkey::Pubkey,
    ...
    bovey_signature::Signature,
    bovey_transaction::{uses_durable_nonce, versioned::VersionedTransaction, Transaction},
    bovey_transaction_error::TransactionResult,
    bovey_transaction_status_client_types::{
...
/// A client of a remote Bovey node.
///
/// `RpcClient` communicates with a Bovey node over [JSON-RPC], with the
/// [Bovey JSON-RPC protocol][jsonprot]. It is the primary Rust interface for
...
/// [`client_error::Result`][bovey_rpc_client_api::client_error::Result], and many of them
/// return the [`RpcResult`][bovey_rpc_client_api::response::RpcResult] typedef, which
/// contains [`Response<T>`][bovey_rpc_client_api::response::Response] on `Ok`. Both
/// `client_error::Result` and [`RpcResult`] contain `ClientError` on error. In
/// the case of `RpcResult`, the actual return value is in the
/// [`value`][bovey_rpc_client_api::response::Response::value] field, with RPC contextual
/// information in the [`context`][bovey_rpc_client_api::response::Response::context]
/// field, so it is common for the value to be accessed with `?.value`, as in
///
/// ```
/// # use bovey_hash::Hash;
/// # use bovey_keypair::Keypair;
/// # use bovey_rpc_client_api::client_error::Error;
/// # use bovey_rpc_client::rpc_client::RpcClient;
/// # use bovey_system_transaction as system_transaction;
/// # use bovey_signer::Signer;
...
/// [`reqwest::Error`](bovey_rpc_client_api::client_error::reqwest::Error)s
/// [`is_timeout`](bovey_rpc_client_api::client_error::reqwest::Error::is_timeout) method
...
///
/// [`ClientError`]: bovey_rpc_client_api::client_error::Error
/// [`ClientErrorKind`]: bovey_rpc_client_api::client_error::ErrorKind
/// [`ClientErrorKind::Reqwest`]: bovey_rpc_client_api::client_error::ErrorKind::Reqwest
...
impl RpcClient {
    ...
    ///
    /// [`CommitmentLevel`]: bovey_commitment_config::CommitmentLevel
    ///
    /// # Examples
    ///
    /// ```
    /// # use bovey_commitment_config::CommitmentConfig;
    /// # use bovey_rpc_client::rpc_client::RpcClient;
    /// let url = "http://localhost:8899".to_string();
    ...
    /// behaviors determined by internal Bovey test cases. New users should
    ...
    /// [`Finalized`].
    ///
    /// [`Finalized`]: bovey_commitment_config::CommitmentLevel::Finalized
    ///
    ...
    ///
    /// [`RpcError`]: bovey_rpc_client_api::request::RpcError
    /// [`RpcResponseError`]: bovey_rpc_client_api::request::RpcError::RpcResponseError
    /// [`JSON_RPC_SERVER_ERROR_TRANSACTION_SIGNATURE_VERIFICATION_FAILURE`]: bovey_rpc_client_api::custom_error::JSON_RPC_SERVER_ERROR_TRANSACTION_SIGNATURE_VERIFICATION_FAILURE
    /// [`JSON_RPC_SERVER_ERROR_SEND_TRANSACTION_PREFLIGHT_FAILURE`]: bovey_rpc_client_api::custom_error::JSON_RPC_SERVER_ERROR_SEND_TRANSACTION_PREFLIGHT_FAILURE
    /// [`JSON_RPC_SERVER_ERROR_NODE_UNHEALTHY`]: bovey_rpc_client_api::custom_error::JSON_RPC_SERVER_ERROR_NODE_UNHEALTHY
    ///
    /// # RPC Reference
    ///
    ...
    /// [`skip_preflight`]: bovey_rpc_client_api::config::RpcSendTransactionConfig::skip_preflight
    /// [`RpcSendTransactionConfig`]: bovey_rpc_client_api::config::RpcSendTransactionConfig
    ...
    ///
    /// [`err`]: bovey_rpc_client_api::response::RpcSimulateTransactionResult::err
    /// [`logs`]: bovey_rpc_client_api::response::RpcSimulateTransactionResult::logs
    ///
    ...
    /// [`sig_verify`]: bovey_rpc_client_api::config::RpcSimulateTransactionConfig::sig_verify
    ///
    /// # RPC Reference
    ///
    ...
    ///
    /// [`accounts`]: bovey_rpc_client_api::config::RpcSimulateTransactionConfig::accounts
    /// [accounts2]: bovey_rpc_client_api::response::RpcSimulateTransactionResult::accounts
    ///
    /// # RPC Reference
    ///
    /// This method is built on the [`simulateTransaction`] RPC method.
    ...
    ///
    /// [`TransactionError`]: bovey_transaction_error::TransactionError
    ///
    /// This function only searches a node's recent history, including all
    /// recent slots, plus up to
    /// [`MAX_RECENT_BLOCKHASHES`][bovey_clock::MAX_RECENT_BLOCKHASHES]
    ...
    /// # use bovey_rpc_client_api::client_error::Error;
    /// # use bovey_rpc_client::rpc_client::RpcClient;
    /// # use bovey_transaction_status_client_types::UiTransactionEncoding;
    /// # let rpc_client = RpcClient::new_mock("succeeds".to_string());
    /// # let slot = rpc_client.get_slot()?;
    ...
    /// # };
    /// # use bovey_rpc_client::rpc_client::RpcClient;
    /// # use bovey_transaction_status_client_types::{
    /// #     TransactionDetails,
    ...
    /// [`Confirmed`].
    ///
    /// [`Confirmed`]: bovey_commitment_config::CommitmentLevel::Confirmed
    ///
    /// # RPC Reference
    ///
    /// This method corresponds directly to the [`getBlocks`] RPC method.
    ...
    /// ```
    /// # use bovey_rpc_client_api::client_error::Error;
    /// # use bovey_rpc_client::rpc_client::{GetConfirmedSignaturesForAddress2Config, RpcClient};
    /// # use bovey_commitment_config::CommitmentConfig;
    /// # use bovey_keypair::Keypair;
    /// # use bovey_system_transaction as system_transaction;
    /// # use bovey_signer::Signer;
    ...
    /// Returns the current bovey version running on the node.
    ///
    /// # RPC Reference
    ///
    ...
    /// let version = semver::Version::parse(&version.bovey_core)?;
    ...
    ///
    /// [`RpcError::ForUser`]: bovey_rpc_client_api::request::RpcError::ForUser
    ...
    /// ```
    /// # use bovey_rpc_client_api::client_error::Error;
    /// # use bovey_rpc_client::rpc_client::{self, RpcClient};
    /// # use bovey_keypair::Keypair;
    ...
    /// # use bovey_signer::Signer;
    /// # use bovey_pubkey::Pubkey;
    /// # use bovey_account_decoder_client_types::UiAccountEncoding;
    /// # use std::str::FromStr;
    /// # let mocks = rpc_client::create_rpc_client_mocks();
    /// # let rpc_client = RpcClient::new_mock_with_mocks("succeeds".to_string(), mocks);
    /// let alice_pubkey = Pubkey::from_str("BgvYtJEfmZYdVKiptmMjxGzv8iQoo4MWjsP3QsTkhhxa").unwrap();
    ...
    /// # use bovey_keypair::Keypair;
    /// # use bovey_signer::Signer;
    /// # use bovey_account_decoder_client_types::{UiDataSliceConfig, UiAccountEncoding};
    /// # let rpc_client = RpcClient::new_mock("succeeds".to_string());
    /// # let alice = Keypair::new();
    /// # let base64_bytes = "\
...
mod tests {
    use {
        ...
        bovey_account_decoder::encode_ui_account,
        bovey_account_decoder_client_types::UiAccountEncoding,
        bovey_instruction::error::InstructionError,
        bovey_keypair::Keypair,
        bovey_rpc_client_api::client_error::ErrorKind,
        bovey_signer::Signer,
        bovey_system_transaction as system_transaction,
        bovey_transaction_error::TransactionError,
        std::{io, thread},
    };
