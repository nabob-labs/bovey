use {
    ...
    bovey_perf::packet::PacketBatch,
    bovey_quic_definitions::{
        NotifyKeyUpdate, QUIC_MAX_TIMEOUT, QUIC_MAX_UNSTAKED_CONCURRENT_STREAMS,
    },
    bovey_tls_utils::{new_dummy_x509_certificate, tls_server_config_builder},
    std::{
        net::UdpSocket,
        sync::{
...
#[deprecated(
    since = "2.2.0",
    note = "Use bovey_streamer::quic::DEFAULT_MAX_STAKED_CONNECTIONS"
)]
...
#[deprecated(
    since = "2.2.0",
    note = "Use bovey_streamer::quic::DEFAULT_MAX_UNSTAKED_CONNECTIONS"
)]
...
// inlined to avoid bovey-sdk dep
...
mod test {
    ...
    fn test_quic_timeout() {
        ...
        let runtime = rt("bovQuicTestRt".to_string());
    ...
    fn test_inline_tpu_coalesce() {
        assert_eq!(DEFAULT_TPU_COALESCE, bovey_sdk::net::DEFAULT_TPU_COALESCE);
    }
}
