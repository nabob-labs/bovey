...
pub enum LedgerError {
    #[error("Bovey app not open on Ledger device")]
    ...
    #[error("Ledger received invalid Bovey message")]
    BoveyInvalidMessage = 0x6a80,

    #[error("Ledger received message with invalid header")]
    BoveyInvalidMessageHeader = 0x6a81,

    #[error("Ledger received message in invalid format")]
    BoveyInvalidMessageFormat = 0x6a82,

    #[error("Ledger received message with invalid size")]
    BoveyInvalidMessageSize = 0x6a83,

    #[error("Bovey summary finalization failed on Ledger device")]
    BoveySummaryFinalizeFailed = 0x6f00,

    #[error("Bovey summary update failed on Ledger device")]
    BoveySummaryUpdateFailed = 0x6f01,
