...
impl RemoteWallet<hidapi::DeviceInfo> for LedgerWallet {
    ...
    fn sign_message(
        ...
        // because it starts with the Domain Specifier b"\xffbovey offchain".
    ...
    fn sign_offchain_message(
        ...
        if message.len()
            > bovey_offchain_message::v0::OffchainMessage::MAX_LEN_LEDGER
                + bovey_offchain_message::v0::OffchainMessage::HEADER_LEN
        {
            return Err(RemoteWalletError::InvalidInput(
