...
use {
    ...
    bovey_net_utils::{SocketConfig, VALIDATOR_PORT_RANGE},
    bovey_quic_definitions::{
        QUIC_CONNECTION_HANDSHAKE_TIMEOUT, QUIC_KEEP_ALIVE, QUIC_MAX_TIMEOUT, QUIC_SEND_FAIRNESS,
    },
    bovey_rpc_client_api::client_error::ErrorKind as ClientErrorKind,
    bovey_streamer::nonblocking::quic::ALPN_TPU_PROTOCOL_ID,
    bovey_tls_utils::{
...
impl QuicLazyInitializedEndpoint {
    ...
    fn create_endpoint(&self) -> Endpoint {
        let mut endpoint = if let Some(endpoint) = &self.client_endpoint {
            ...
            let client_socket = bovey_net_utils::bind_in_range_with_config(
