...
use {
    ...
    bovey_turbine::broadcast_stage::BroadcastStageType,
    static_assertions,
    std::{
        collections::HashSet,
        fs, iter,
...
pub const RUST_LOG_FILTER: &str =
    "error,bovey_core::replay_stage=warn,bovey_local_cluster=info,local_cluster=info";

pub const DEFAULT_NODE_STAKE: u64 = 10 * LAMPORTS_PER_BOV;
...
pub fn run_cluster_partition<C>(
    ...
    bovey_logger::setup_with_default(RUST_LOG_FILTER);
    info!("PARTITION_TEST!");
...
pub fn test_faulty_node(
    ...
    let fixed_leader_schedule = custom_leader_schedule.unwrap_or_else(|| {
        ...
        let validator_to_slots = vec![(
            ...
            bovey_sdk::clock::DEFAULT_DEV_SLOTS_PER_EPOCH as usize,
        )];
