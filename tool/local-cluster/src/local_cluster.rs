use {
    ...
    bovey_ledger::{create_new_tmp_ledger_with_size, shred::Shred},
    ...
    bovey_streamer::{socket::SocketAddrSpace, streamer::StakedNodes},
...
pub const DEFAULT_MINT_LAMPORTS: u64 = 10_000_000 * LAMPORTS_PER_BOV;
