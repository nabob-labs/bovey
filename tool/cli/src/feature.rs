use {
    ...
    bovey_cli_output::{cli_version::CliVersion, QuietDisplay, VerboseDisplay},
    bovey_clock::{Epoch, Slot},
    bovey_cluster_type::ClusterType,
    bovey_epoch_schedule::EpochSchedule,
    bovey_feature_gate_client::{
        errors::BoveyFeatureGateError, instructions::RevokePendingActivation,
    },
    bovey_feature_gate_interface::{activate_with_lamports, from_account, Feature},
    ...
    bovey_sdk_ids::{incinerator, system_program},
...
> {
    ...
    let tool_version = bovey_version::Version::default();
...
fn process_revoke(
    ...
    log_instruction_custom_error::<BoveyFeatureGateError>(result, config)
}
