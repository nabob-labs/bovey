...
use bovey_decode_error::DecodeError;
...
pub enum SystemError {
    ...
    AccountAlreadyInUse,
    /// Account does not have enough BOV to perform the operation.
    ...
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        match self {
            ...
            SystemError::ResultWithNegativeLamports => {
                f.write_str("account does not have enough BOV to perform the operation")
            }
