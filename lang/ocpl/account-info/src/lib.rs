...
use {
    ...
    bovey_program_memory::bov_memset,
    bovey_pubkey::Pubkey,
    std::{
...
impl<'a> AccountInfo<'a> {
    ...
    /// `bovey_program::entrypoint::MAX_PERMITTED_DATA_INCREASE` bytes.
    ///
    ...
    pub fn realloc(&self, new_len: usize, zero_init: bool) -> Result<(), ProgramError> {
        ...
        if zero_init {
            ...
            if len_increase > 0 {
                bov_memset(&mut data[old_len..], 0, len_increase);
            }
        }
...
/// ```
/// use bovey_program_error::ProgramResult;
/// use bovey_account_info::{AccountInfo, next_account_info, next_account_infos};
/// use bovey_pubkey::Pubkey;
/// # use bovey_program_error::ProgramError;
///
/// pub fn process_instruction(
