//! The definition of a Bovey network packet.
...
#[cfg(feature = "frozen-abi")]
impl ::bovey_frozen_abi::abi_example::AbiExample for PacketFlags {
    fn example() -> Self {
        Self::empty()
    }
}
...
#[cfg(feature = "frozen-abi")]
impl ::bovey_frozen_abi::abi_example::TransparentAsHelper for PacketFlags {}

#[cfg(feature = "frozen-abi")]
impl ::bovey_frozen_abi::abi_example::EvenAsOpaque for PacketFlags {
