...
use {
    crate::Transaction, bovey_message::VersionedMessage, bovey_sanitize::SanitizeError,
    bovey_signature::Signature, std::cmp::Ordering,
};
#[cfg(feature = "serde")]
use {
...
impl VersionedTransaction {
    ...
    pub fn verify_and_hash_message(
        &self,
    ) -> bovey_transaction_error::TransactionResult<bovey_hash::Hash> {
        ...
        {
            Err(bovey_transaction_error::TransactionError::SignatureFailure)
        } else {
...
mod tests {
    use {
        ...
        bovey_message::Message as LegacyMessage,
        bovey_pubkey::Pubkey,
        bovey_signer::Signer,
