...
pub mod syscalls {
    pub use bovey_define_syscall::definitions::{
        bov_memcmp_, bov_memcpy_, bov_memmove_, bov_memset_,
    };
}
...
pub mod stubs {
    ...
    /// # Safety
    pub unsafe fn bov_memcpy(dst: *mut u8, src: *const u8, n: usize) {
    ...
    /// # Safety
    pub unsafe fn bov_memmove(dst: *mut u8, src: *const u8, n: usize) {
        std::ptr::copy(src, dst, n);
    }
    /// # Safety
    pub unsafe fn bov_memcmp(s1: *const u8, s2: *const u8, n: usize, result: *mut i32) {
        let mut i = 0;
        while i < n {
            let a = *s1.add(i);
            let b = *s2.add(i);
    ...
    /// # Safety
    pub unsafe fn bov_memset(s: *mut u8, c: u8, n: usize) {
...
#[inline]
pub fn bov_memcpy(dst: &mut [u8], src: &[u8], n: usize) {
    #[cfg(target_os = "bovey")]
    unsafe {
        syscalls::bov_memcpy_(dst.as_mut_ptr(), src.as_ptr(), n as u64);
    }

    #[cfg(not(target_os = "bovey"))]
    unsafe {
        stubs::bov_memcpy(dst.as_mut_ptr(), src.as_ptr(), n);
    }
}
...
pub unsafe fn bov_memmove(dst: *mut u8, src: *const u8, n: usize) {
    #[cfg(target_os = "bovey")]
    syscalls::bov_memmove_(dst, src, n as u64);
...
/// likely introduce undefined behavior.
#[inline]
pub fn bov_memcmp(s1: &[u8], s2: &[u8], n: usize) -> i32 {
    let mut result = 0;

    #[cfg(target_os = "bovey")]
    unsafe {
        syscalls::bov_memcmp_(s1.as_ptr(), s2.as_ptr(), n as u64, &mut result as *mut i32);
    }

    #[cfg(not(target_os = "bovey"))]
    unsafe {
        stubs::bov_memcmp(s1.as_ptr(), s2.as_ptr(), n, &mut result as *mut i32);
    }
...
/// undefined behavior.
#[inline]
pub fn bov_memset(s: &mut [u8], c: u8, n: usize) {
    #[cfg(target_os = "bovey")]
    unsafe {
        syscalls::bov_memset_(s.as_mut_ptr(), c, n as u64);
    }

    #[cfg(not(target_os = "bovey"))]
    unsafe {
        stubs::bov_memset(s.as_mut_ptr(), c, n);
    }
}
