...
#[deprecated(
    since = "2.2.0",
    note = "Use `bovey_cluster_type::ClusterType` instead."
)]
pub use bovey_cluster_type::ClusterType;
...
use {
    ...
    bovey_shred_version::compute_shred_version,
    std::{
        fmt,
        fs::{File, OpenOptions},
        io::Write,
...
use {
    bovey_account::{Account, AccountSharedData},
    bovey_clock::{UnixTimestamp, DEFAULT_TICKS_PER_SLOT},
    ...
    bovey_signer::Signer,
    bovey_time_utils::years_as_slots,
    std::{
...
pub struct GenesisConfig {
    ...
    /// with the Bovey v0.23 release line
    ...
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(
            ...
            "\
             ...
             {:?}\n\
             {:?}\n\
             Capitalization: {} BOV in {} accounts\n\
...
mod tests {
    use {super::*, bovey_signer::Signer, std::path::PathBuf};
    ...
    fn test_genesis_config() {
        ...
        config.add_native_instruction_processor("hi".to_string(), bovey_pubkey::new_rand());
