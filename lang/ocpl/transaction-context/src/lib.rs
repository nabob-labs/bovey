...
use {bovey_account::WritableAccount, bovey_rent::Rent, std::mem::MaybeUninit};
use {
...
// Inlined to avoid bovey_system_interface dep
#[cfg(not(target_os = "bovey"))]
...
static_assertions::const_assert_eq!(
    ...
    bovey_system_interface::MAX_PERMITTED_ACCOUNTS_DATA_ALLOCATIONS_PER_TRANSACTION
);

// Inlined to avoid bovey_account_info dep
#[cfg(not(target_os = "bovey"))]
const MAX_PERMITTED_DATA_INCREASE: usize = 1_024 * 10;
#[cfg(test)]
static_assertions::const_assert_eq!(
    MAX_PERMITTED_DATA_INCREASE,
    bovey_account_info::MAX_PERMITTED_DATA_INCREASE
);
...
impl TransactionContext {
    ...
    /// `bovey_sdk::instruction::TRANSACTION_LEVEL_STACK_HEIGHT`
