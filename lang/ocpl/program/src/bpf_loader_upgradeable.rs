#[deprecated(since = "2.2.0", note = "Use bovey-loader-v3-interface instead")]
#[allow(deprecated)]
pub use bovey_loader_v3_interface::{
...
pub use bovey_sdk_ids::bpf_loader_upgradeable::{check_id, id, ID};
