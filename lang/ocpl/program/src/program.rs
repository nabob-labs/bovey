//! Wrappers around [`bovey-cpi`] with support for overwriting
//! syscall stubs
//!
...
//! functions.
//!
pub use bovey_cpi::MAX_RETURN_DATA;
use {
    crate::{
...
/// Like [`bovey_cpi::invoke`], but with support
/// for overwriting the `bov_invoke_signed` syscall stub.
///
pub fn invoke(instruction: &Instruction, account_infos: &[AccountInfo]) -> ProgramResult {
    invoke_signed(instruction, account_infos, &[])
}

/// Like [`bovey_cpi::invoke_unchecked`], but with support
/// for overwriting the `bov_invoke_signed` syscall stub.
///
/// # Safety
///
...
/// Like [`bovey_cpi::invoke_signed`], but with support
/// for overwriting the `bov_invoke_signed` syscall stub.
///
...
/// Like [`bovey_cpi::invoke_signed_unchecked`], but with support
/// for overwriting the `bov_invoke_signed` syscall stub.
///
/// # Safety
///
...
pub fn invoke_signed_unchecked(
    ...
    #[cfg(target_os = "bovey")]
    {
        bovey_cpi::invoke_signed_unchecked(instruction, account_infos, signers_seeds)
    }

    #[cfg(not(target_os = "bovey"))]
    crate::program_stubs::bov_invoke_signed(instruction, account_infos, signers_seeds)
}

/// Like [`bovey_cpi::set_return_data`], but with support
/// for overwriting the `bov_set_return_data` syscall stub.
///
pub fn set_return_data(data: &[u8]) {
    #[cfg(target_os = "bovey")]
    {
        bovey_cpi::set_return_data(data);
    }

    #[cfg(not(target_os = "bovey"))]
    crate::program_stubs::bov_set_return_data(data)
}

/// Like [`bovey_cpi::get_return_data`], but with support
/// for overwriting the `bov_get_return_data` syscall stub.
///
pub fn get_return_data() -> Option<(Pubkey, Vec<u8>)> {
    #[cfg(target_os = "bovey")]
    {
        bovey_cpi::get_return_data()
    }

    #[cfg(not(target_os = "bovey"))]
    crate::program_stubs::bov_get_return_data()
}
