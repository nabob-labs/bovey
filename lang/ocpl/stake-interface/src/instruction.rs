...
use {
    ...
    bovey_clock::{Epoch, UnixTimestamp},
    bovey_pubkey::Pubkey,
};
#[cfg(feature = "bincode")]
use {
...
pub fn create_account_with_seed(
    ...
    vec![
        bovey_system_interface::instruction::create_account_with_seed(
            from_pubkey,
            stake_pubkey,
            base,
            seed,
...
pub fn create_account(
    ...
    vec![
        bovey_system_interface::instruction::create_account(
            from_pubkey,
            stake_pubkey,
            lamports,
            StakeStateV2::size_of() as u64,
...
pub fn split(
    ...
    vec![
        bovey_system_interface::instruction::allocate(
            split_stake_pubkey,
            StakeStateV2::size_of() as u64,
        ),
        bovey_system_interface::instruction::assign(split_stake_pubkey, &ID),
        _split(
            stake_pubkey,
            authorized_pubkey,
            lamports,
...
pub fn split_with_seed(
    ...
    vec![
        bovey_system_interface::instruction::allocate_with_seed(
            split_stake_pubkey,
            base,
            seed,
            StakeStateV2::size_of() as u64,
...
pub fn redelegate(
    ...
    vec![
        ...
        bovey_system_interface::instruction::assign(uninitialized_stake_pubkey, &ID),
        _redelegate(
            stake_pubkey,
            authorized_pubkey,
            vote_pubkey,
...
mod tests {
    ...
    fn test_constants() {
        ...
        assert_eq!(CLOCK_ID, bovey_program::sysvar::clock::ID);

        // Ensure that the constants are in sync with the bovey_ program.
        assert_eq!(STAKE_HISTORY_ID, bovey_program::sysvar::stake_history::ID);

        // Ensure that the constants are in sync with the bovey_ rent.
        assert_eq!(RENT_ID, bovey_program::sysvar::rent::ID);
    }
}
