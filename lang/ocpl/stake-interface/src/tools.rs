//! Utility functions
use {crate::MINIMUM_DELINQUENT_EPOCHS_FOR_DEACTIVATION, bovey_clock::Epoch};
#[cfg(feature = "bincode")]
use {
    bovey_cpi::{get_return_data, invoke_unchecked},
...
/// [`get_return_data()`]: bovey_cpi::get_return_data
#[cfg(feature = "bincode")]
