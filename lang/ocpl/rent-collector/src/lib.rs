...
use {
    ...
    bovey_pubkey::Pubkey,
    bovey_rent::{Rent, RentDue},
    bovey_sdk_ids::incinerator,
};
...
mod tests {
    use {
        super::*, assert_matches::assert_matches, bovey_account::Account, bovey_sdk_ids::sysvar,
    };
    ...
    fn test_collect_from_account_created_and_existing() {
        ...
        let collected = rent_collector
            .collect_from_created_account(&bovey_pubkey::new_rand(), &mut created_account);
        ...
        let collected = rent_collector
            .collect_from_existing_account(&bovey_pubkey::new_rand(), &mut existing_account);
