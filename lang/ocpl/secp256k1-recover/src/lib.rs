...
//!
//! While `secp256k1_recover` can be used to verify secp256k1 signatures, Bovey
...
#[cfg(target_os = "bovey")]
pub use bovey_define_syscall::definitions::bov_secp256k1_recover;
...
/// comparing the recovered key against an expected key, Bovey also provides
...
///
/// ```rust
/// # use bovey_program::program_error::ProgramError;
/// # let signature_bytes = [
...
/// version 0.7.0 or greater is required for running on the Bovey SBF target.
///
/// [`libsecp256k1`]: https://docs.rs/libsecp256k1/latest/libsecp256k1
///
...
/// signature with the `secp256k1_recover` syscall. It has three parts: a Bovey
...
/// };
/// use bovey_secp256k1_recover::secp256k1_recover;
///
