...
pub use {
    ...
    bovey_sdk_ids::sysvar::epoch_rewards::{check_id, id, ID},
};

#[cfg(feature = "bincode")]
impl Sysvar for EpochRewards {
    impl_sysvar_get!(bov_get_epoch_rewards_sysvar);
}
