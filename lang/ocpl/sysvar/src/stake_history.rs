...
//! # use bovey_program::stake_history::StakeHistory;
//! # use bovey_sdk::account::Account;
//! # use bovey_rpc_client::rpc_client::RpcClient;
//! # use bovey_sdk_ids::sysvar::stake_history;
//! # use anyhow::Result;
//! #
...
#[cfg(feature = "bincode")]
use crate::Sysvar;
pub use bovey_sdk_ids::sysvar::stake_history::{check_id, id, ID};
#[deprecated(
    since = "2.2.0",
    note = "Use bovey_stake_interface::stake_history instead"
)]
pub use bovey_stake_interface::stake_history::{
    StakeHistory, StakeHistoryEntry, StakeHistoryGetEntry, MAX_ENTRIES,
};
use {crate::get_sysvar, bovey_clock::Epoch};
