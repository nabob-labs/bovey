...
pub use bovey_sdk_ids::sysvar::fees::{check_id, id, ID};
use {
    bovey_fee_calculator::FeeCalculator, bovey_sdk_macro::CloneZeroed,
    bovey_sysvar_id::impl_deprecated_sysvar_id,
};
...
impl Sysvar for Fees {
    impl_sysvar_get!(bov_get_fees_sysvar);
}
