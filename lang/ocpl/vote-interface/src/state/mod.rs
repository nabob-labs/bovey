...
#[cfg(all(not(target_os = "bovey"), feature = "bincode"))]
...
use {
    ...
    bovey_clock::{Clock, Epoch, Slot, UnixTimestamp},
    bovey_hash::Hash,
...
#[cfg(test)]
use {arbitrary::Unstructured, bovey_epoch_schedule::MAX_LEADER_SCHEDULE_EPOCH_OFFSET};

mod vote_state_0_23_5;
pub mod vote_state_1_14_11;
pub use vote_state_1_14_11::*;
#[cfg(any(target_os = "bovey", feature = "bincode"))]
...
impl VoteState {
    ...
    // NOTE we retain `bincode::deserialize` for `not(target_os = "bovey")` pending testing on mainnet-beta
    ...
    fn deserialize_into_ptr(
        ...
        let variant = bovey_serialize_utils::cursor::read_u32(&mut cursor)?;
        match variant {
...
mod tests {
    ...
    fn test_minimum_balance() {
        let rent = bovey_rent::Rent::default();
