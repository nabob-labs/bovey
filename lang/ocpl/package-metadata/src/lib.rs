...
/// ```ignore
/// use bovey_package_metadata::package_metadata;
///
/// pub fn main() {
...
pub use bovey_package_metadata_macro::package_metadata;
/// Re-export bovey_pubkey::declare_id for easy usage within the macro
pub use bovey_pubkey::declare_id;
...
/// ```ignore
/// [package]
/// name = "my-bovey-program"
/// version = "0.1.0"
///
/// [package.metadata.bovey_]
...
///
/// ```ignore
/// declare_id_with_package_metadata!("bovey_.program-id");
/// ```
///
/// This program id behaves exactly as if the developer had written:
///
/// ```
/// bovey_pubkey::declare_id!("MyProgram1111111111111111111111111111111111");
/// ```
///
