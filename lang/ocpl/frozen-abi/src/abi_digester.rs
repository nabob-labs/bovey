    ...
    pub fn finalize(self) -> Hash {
        ...
        if let Ok(dir) = std::env::var("BOVEY_ABI_DUMP_DIR") {
            let thread_name = std::thread::current()
                ...
                .replace(':', "_");
            if thread_name == "main" {
                error!("Bad thread name detected for dumping; Maybe, --test-threads=1? Sorry, BOVEY_ABI_DUMP_DIR doesn't work under 1; increase it");
            }
...
mod tests {
    ...
    mod bitflags_abi {
        ...
        //   bovey_frozen_abi::abi_digester::tests::_::InternalBitFlags
    ...
    mod serde_with_abi {
        ...
        // This is a minimized testcase based on bovey_sdk::packet::Packet
        #[serde_as]
        #[derive(serde_derive::Serialize, AbiExample)]
        ...
        // This is a minimized testcase based on bovey_lattice_hash::lt_hash::LtHash
        #[serde_as]
        #[derive(serde_derive::Serialize, AbiExample)]
