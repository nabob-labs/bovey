...
use bovey_frozen_abi_macro::AbiExample;
use {
    crate::{
    ...
    bovey_pubkey::Pubkey,
    bovey_sanitize::SanitizeError,
    bovey_sdk_ids::bpf_loader_upgradeable,
...
/// A Bovey transaction message (v0).
///
...
impl Message {
    ...
    /// # Examples
    ///
    /// This example uses the [`bovey_rpc_client`], [`bovey_sdk`], and [`anyhow`] crates.
    ///
    /// ```
    /// # use bovey_program::example_mocks::{
    /// #     bovey_rpc_client,
    /// #     bovey_sdk,
    /// # };
    /// # use std::borrow::Cow;
    ...
    /// use bovey_message::{AddressLookupTableAccount, VersionedMessage, v0};
    /// use bovey_pubkey::Pubkey;
    /// use bovey_rpc_client::rpc_client::RpcClient;
    /// use bovey_program::address_lookup_table::{self, state::{AddressLookupTable, LookupTableMeta}};
    /// use bovey_sdk::{
...
#[cfg(test)]
mod tests {
    use {super::*, crate::VersionedMessage, bovey_instruction::AccountMeta};
