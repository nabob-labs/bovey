...
//!
//! In Bovey, programs execute instructions, and clients submit sequences
...
//! version as of Bovey 1.10.0. `v0` is a [future message format] that encodes
...
//!
//! Despite living in the `bovey-program` crate, there is no way to access the
//! runtime's messages from within a Bovey program, and only the legacy message
//! types continue to be exposed to Bovey programs, for backwards compatibility
//! reasons.
...
pub struct AddressLookupTableAccount {
    pub key: bovey_pubkey::Pubkey,
    pub addresses: Vec<bovey_pubkey::Pubkey>,
}
