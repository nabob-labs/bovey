...
///
/// The Bovey syscalls still expect the inputs to be encoded in big-endian as
...
///
/// THe Bovey syscalls still expect the inputs to be encoded as specified in
...
#[cfg(target_os = "bovey")]
mod target_arch {
    use {super::*, bovey_define_syscall::definitions as syscalls};
    ...
    pub fn alt_bn128_addition(input: &[u8]) -> Result<Vec<u8>, AltBn128Error> {
        ...
        let result = unsafe {
            syscalls::bov_alt_bn128_group_op(
                ALT_BN128_ADD,
