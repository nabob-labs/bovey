...
pub use bovey_sdk_ids::secp256r1_program::{check_id, id, ID};
...
#[cfg(all(not(target_arch = "wasm32"), not(target_os = "bovey")))]
mod target_arch {
    use {
        ...
        bovey_precompile_error::PrecompileError,
    };
...
#[cfg(any(target_arch = "wasm32", target_os = "bovey"))]
mod target_arch {
    use {bovey_feature_set::FeatureSet, bovey_precompile_error::PrecompileError};
