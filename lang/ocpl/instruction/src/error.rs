...
use bovey_frozen_abi_macro::{AbiEnumVisitor, AbiExample};
#[cfg(feature = "std")]
use {
...
pub enum InstructionError {
    ...
    /// by the Bovey runtime. A program-specific error may be any type that is represented as
    ...
    /// consistent across Bovey software versions.
    ///
    BorshIoError(String),
