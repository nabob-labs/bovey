//! Types for directing the execution of Bovey programs.
//!
//! Every invocation of a Bovey program executes a single instruction, as
...
//! the Bovey runtime. This allows flexibility in how programs behave, how they
...
/// A directive for a single invocation of a Bovey program.
///
/// An instruction specifies which program it is calling, which accounts it may
/// read or modify, and additional data that serves as input to the program. One
/// or more instructions are included in transactions submitted by Bovey
...
/// construction.
///
/// While Bovey is agnostic to the format of the instruction data, it has
...
///
/// When building a transaction, the Bovey runtime coalesces all accounts used
...
/// when calling the `bov_get_processed_sibling_instruction` syscall.
#[repr(C)]
