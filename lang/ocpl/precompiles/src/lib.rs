...
use {
    lazy_static::lazy_static, bovey_feature_set::FeatureSet,
    bovey_message::compiled_instruction::CompiledInstruction,
    bovey_precompile_error::PrecompileError, bovey_pubkey::Pubkey,
};
...
lazy_static! {
    ...
    static ref PRECOMPILES: Vec<Precompile> = vec![
        Precompile::new(
            ...
            None, // always enabled
            ocp_secp256k1_program::verify,
        ),
        Precompile::new(
            bovey_sdk_ids::ed25519_program::id(),
            None, // always enabled
            ocp_ed25519_program::verify,
        ),
        Precompile::new(
            bovey_sdk_ids::secp256r1_program::id(),
            Some(bovey_feature_set::enable_secp256r1_precompile::id()),
            ocp_secp256r1_program::verify,
        )
    ];
}
