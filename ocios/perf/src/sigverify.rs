...
use {
    ...
    bovey_hash::Hash,
    bovey_message::{MESSAGE_HEADER_LENGTH, MESSAGE_VERSION_PREFIX},
    bovey_pubkey::Pubkey,
...
lazy_static! {
    static ref PAR_THREAD_POOL: ThreadPool = rayon::ThreadPoolBuilder::new()
        ...
        .thread_name(|i| format!("bovSigVerify{i:02}"))
        .build()
        .unwrap();
}
...
mod tests {
    use {
        ...
        bovey_message::{compiled_instruction::CompiledInstruction, Message, MessageHeader},
        bovey_signature::Signature,
        bovey_signer::Signer,
    ...
    fn test_is_simple_vote_transaction() {
        ...
        // multiple mixed tx is not
        {
            ...
            let tx = Transaction::new_with_compiled_instructions(
                ...
                &[key1, key2],
                Hash::default(),
                vec![ocp_vote_program::id(), Pubkey::new_unique()],
                vec![
