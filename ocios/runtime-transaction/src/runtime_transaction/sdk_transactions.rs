use {
    ...
    bovey_message::{AddressLoader, TransactionSignatureDetails},
    bovey_pubkey::Pubkey,
    ...
    pub fn try_from(
        ...
        let precompile_signature_details = get_precompile_signature_details(
            sanitized_versioned_tx
                ...
                .map(|(program_id, ix)| (program_id, VMInstruction::from(ix))),
        );
...
impl RuntimeTransaction<SanitizedTransaction> {
    pub fn from_transaction_for_tests(transaction: bovey_transaction::Transaction) -> Self {
        let versioned_transaction = VersionedTransaction::from(transaction);
        Self::try_create(
            versioned_transaction,
            MessageHash::Compute,
            None,
            bovey_message::SimpleAddressLoader::Disabled,
            &HashSet::new(),
        )
...
mod tests {
    use {
        ...
        bovey_message::{Message, SimpleAddressLoader},
        bovey_program::vote::{self, state::Vote},
