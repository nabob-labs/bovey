...
//! bovey_transaction::sanitized::SanitizedTransaction is client facing representation.
//!
//! It has two states:
//! 1. Statically Loaded: after receiving `packet` from sigverify and deserializing
//!    it into `bovey_transaction::versioned::VersionedTransaction`, then sanitizing into
//!    `bovey_transaction::versioned::sanitized::SanitizedVersionedTransaction`, which can be wrapped into
...
use {
    ...
    core::ops::Deref,
    bovey_compute_budget_instruction::compute_budget_instruction_details::*,
    bovey_hash::Hash,
    bovey_message::{AccountKeys, TransactionSignatureDetails},
    bovey_pubkey::Pubkey,
    ...
    bovey_vm_transaction::{
        ...
        vm_message::VMMessage, vm_transaction::VMTransaction,
    },
};
...
impl<T: VMMessage> DynamicMeta for RuntimeTransaction<T> {}
...
impl<T: VMMessage> VMMessage for RuntimeTransaction<T> {
...
impl<T: VMTransaction> VMTransaction for RuntimeTransaction<T> {
