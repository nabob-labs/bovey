...
use {
    ...
    ocp_stake_program::stake_state::{Stake, StakeStateV2},
...
mod tests {
    use {
        self::points::null_tracer, super::*, bovey_program::stake::state::Delegation,
        bovey_pubkey::Pubkey, bovey_sdk::native_token::bov_to_lamports, test_case::test_case,
    };
    ...
    fn test_stake_state_calculate_points_with_typical_values() {
        ...
        //  10_000_000 BOV is a big but not unreasaonable stake
        let stake = new_stake(
            bov_to_lamports(10_000_000f64),
            &Pubkey::default(),
            &vote_state,
            u64::MAX,
        );
