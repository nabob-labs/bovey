...
impl Bank {
    ...
    pub fn calculate_reward_for_transaction(
        ...
        let fee_details = bovey_fee::calculate_fee_details(
            transaction,
...
pub mod tests {
    use {
        ...
        bovey_sdk::{
            account::AccountSharedData, native_token::bov_to_lamports, pubkey, rent::Rent,
            signature::Signer,
        },
        bovey_vm_rent_collector::rent_state::RentState,
        std::sync::RwLock,
    };
    ...
    fn test_distribute_rent_to_validators_rent_paying() {
        ...
        let genesis_config_info = create_genesis_config_with_vote_accounts(
            bov_to_lamports(1000.),
            &keypairs,
            vec![bov_to_lamports(1000.); 4],
        );
