...
use {
    ...
    bovey_builtins::core_bpf_migration::CoreBpfMigrationConfig,
...
impl Bank {
    ...
    fn directly_invoke_loader_v3_deploy(
        ...
        // instances configured above, then invoke the loader.
        {
            ...
            let load_program_metrics = ocp_bpf_loader_program::deploy_program(
    ...
    ///
    /// ```ignore
    /// if new_feature_activations.contains(&bovey_feature_set::test_upgrade_program::id()) {
...
pub(crate) mod tests {
    use {
        ...
        bovey_program_runtime::loaded_programs::{ProgramCacheEntry, ProgramCacheEntryType},
        bovey_sdk::{
