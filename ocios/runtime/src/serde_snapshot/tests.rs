...
mod serde_snapshot_tests {
    use {
        ...
        bovey_nohash_hasher::BuildNoHashHasher,
        bovey_sdk::{
        ...
        R: Read,
    {
        ...
        reconstruct_accountsdb_from_fields(
            ...
            None,
            false,
            Some(bovey_accounts_db::accounts_db::ACCOUNTS_DB_CONFIG_FOR_TESTING),
            None,
            Arc::default(),
            None,
            (u64::default(), None),
        ...
        F: Fn(AccountsDb, Slot) -> AccountsDb,
    {
        ...
        let pubkey = bovey_pubkey::new_rand();
        let purged_pubkey1 = bovey_pubkey::new_rand();
        let purged_pubkey2 = bovey_pubkey::new_rand();
    ...
    fn test_accounts_purge_long_chained_after_snapshot_restore(storage_access: StorageAccess) {
        ...
        let pubkey = bovey_pubkey::new_rand();
        let dummy_pubkey = bovey_pubkey::new_rand();
        let purged_pubkey1 = bovey_pubkey::new_rand();
        let purged_pubkey2 = bovey_pubkey::new_rand();
