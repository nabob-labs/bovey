use {
    ...
    bovey_sdk::{clock::Epoch, pubkey::Pubkey, stake::state::Delegation},
...
mod tests {
    use {
        super::*, crate::stakes::StakesCache, rand::Rng, bovey_sdk::rent::Rent,
        ocp_stake_program::stake_state, ocp_vote_program::vote_state,
    };
    ...
    fn test_serde_stakes_to_delegation_format() {
        ...
        for _ in 0..rng.gen_range(5usize..10) {
            ...
            let vote_account = vote_state::create_account(
                &vote_pubkey,
                &bovey_pubkey::new_rand(),  // node_pubkey
