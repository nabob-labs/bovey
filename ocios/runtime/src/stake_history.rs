...
pub use bovey_sdk::stake_history::StakeHistoryGetEntry;
use {
    bovey_sdk::{clock::Epoch, stake_history::StakeHistoryEntry},
    std::{
        ops::{Deref, DerefMut},
        sync::Arc,
    },
...
type StakeHistoryInner = bovey_sdk::stake_history::StakeHistory;
...
#[cfg(test)]
mod tests {
    use {super::*, bovey_sdk::stake_history::StakeHistoryEntry};
