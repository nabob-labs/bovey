...
pub(crate) use {
    bovey_accounts_db::accounts_hash::{
...
impl bovey_frozen_abi::abi_example::TransparentAsHelper for SerializableVersionedBank {}
...
#[cfg(feature = "frozen-abi")]
impl bovey_frozen_abi::abi_example::TransparentAsHelper for SerializableAccountsDb<'_> {}
    ...
    E: SerializableStorage + std::marker::Sync,
{
    ...
    let handle = Builder::new()
        .name("bovNfyAccRestor".to_string())
        .spawn(move || {
