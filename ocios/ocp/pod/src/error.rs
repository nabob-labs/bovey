...
use {
    ...
    bovey_msg::msg,
    bovey_program_error::{PrintProgramError, ProgramError},
};

/// Errors that may be returned by the ocp-pod library.
#[repr(u32)]
...
impl<T> bovey_decode_error::DecodeError<T> for PodSliceError {
