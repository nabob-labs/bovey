...
use {
    ...
    bovey_borsh::v1::{get_instance_packed_len, try_from_slice_unchecked},
...
impl OcpDiscriminate for TokenMetadata {
...
mod tests {
    ...
    fn discriminator() {
        ...
        assert_eq!(TokenMetadata::OCP_DISCRIMINATOR, discriminator);
    }
