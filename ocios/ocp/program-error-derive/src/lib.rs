//! Crate defining a procedural macro for building Bovey program errors

// Required to include `#[allow(clippy::integer_arithmetic)]`
// below since the tokens generated by `quote!` in the implementation
// for `MacroType::PrintProgramError` and `MacroType::OcpProgramError`
...
/// Derive macro to add `Into<bovey_program::program_error::ProgramError>`
/// trait
...
/// Derive macro to add `bovey_program::decode_error::DecodeError` trait
...
/// Derive macro to add `bovey_program::program_error::PrintProgramError` trait
...
/// Proc macro attribute to turn your enum into a Bovey Program Error
///
/// Adds:
/// - `Clone`
/// - `Debug`
...
/// - `Into<bovey_program::program_error::ProgramError>`
/// - `bovey_program::decode_error::DecodeError`
...
///
/// Syntax: `#[ocp_program_error(hash_error_code_start = 1275525928)]`
/// Hash Input: `ocp_program_error:<enum name>:<variant name>`
/// Value: `u32::from_le_bytes(<hash of input>[13..17])`
#[proc_macro_attribute]
pub fn ocp_program_error(attr: TokenStream, input: TokenStream) -> TokenStream {
    let args = parse_macro_input!(attr as OcpProgramErrorArgs);
    let item_enum = parse_macro_input!(input as ItemEnum);
    MacroType::OcpProgramError { args, item_enum }
        .generate_tokens()
        .into()
}
