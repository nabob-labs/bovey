...
pub use bovey_sdk_ids::config::id;
#[allow(deprecated)]
use bovey_stake_interface::config::Config as StakeConfig;
use {
...
// TODO move ConfigState into `bovey_program` to implement trait locally
#[allow(deprecated)]
