...
use {
    ...
    ocp_discriminator::{ArrayDiscriminator, OcpDiscriminate},
    ocp_pod::bytemuck::{pod_from_bytes, pod_from_bytes_mut},
...
fn get_bytes<V: OcpDiscriminate>(
    tlv_data: &[u8],
...
///     ocp_discriminator::{ArrayDiscriminator, OcpDiscriminate},
///     ocp_type_length_value::state::{TlvState, TlvStateBorrowed, TlvStateMut},
/// };
/// #[repr(C)]
...
///     data: [u8; 8],
/// }
/// impl OcpDiscriminate for MyPodValue {
///     const OCP_DISCRIMINATOR: ArrayDiscriminator = ArrayDiscriminator::new([1; ArrayDiscriminator::LENGTH]);
/// }
/// #[repr(C)]
/// #[derive(Clone, Copy, Debug, Default, PartialEq, Pod, Zeroable)]
...
///     data: u8,
/// }
/// impl OcpDiscriminate for MyOtherPodValue {
///     const OCP_DISCRIMINATOR: ArrayDiscriminator = ArrayDiscriminator::new([2; ArrayDiscriminator::LENGTH]);
/// }
/// let buffer = [
...
pub trait TlvState {
    ...
    /// number specified
    fn get_value_with_repetition<V: OcpDiscriminate + Pod>(
        &self,
        repetition_number: usize,
    ...
    /// entry found
    fn get_first_value<V: OcpDiscriminate + Pod>(&self) -> Result<&V, ProgramError> {
    ...
    fn get_variable_len_value_with_repetition<V: OcpDiscriminate + VariableLenPack>(
        &self,
        repetition_number: usize,
    ) -> Result<V, ProgramError> {
        let data = get_bytes::<V>(self.get_data(), repetition_number)?;
    ...
    fn get_first_variable_len_value<V: OcpDiscriminate + VariableLenPack>(
        &self,
    ) -> Result<V, ProgramError> {
    ...
    fn get_bytes_with_repetition<V: OcpDiscriminate>(
        &self,
        repetition_number: usize,
    ) -> Result<&[u8], ProgramError> {
    ...
    fn get_first_bytes<V: OcpDiscriminate>(&self) -> Result<&[u8], ProgramError> {
...
impl<'data> TlvStateMut<'data> {
    ...
    pub fn get_value_with_repetition_mut<V: OcpDiscriminate + Pod>(
        &mut self,
        repetition_number: usize,
    ...
    pub fn get_first_value_mut<V: OcpDiscriminate + Pod>(
        &mut self,
    ) -> Result<&mut V, ProgramError> {
    ...
    /// specified
    pub fn get_bytes_with_repetition_mut<V: OcpDiscriminate>(
        &mut self,
        repetition_number: usize,
    ...
    /// found
    pub fn get_first_bytes_mut<V: OcpDiscriminate>(&mut self) -> Result<&mut [u8], ProgramError> {
    ...
    pub fn init_value<V: OcpDiscriminate + Pod + Default>(
        &mut self,
    ...
    pub fn pack_variable_len_value_with_repetition<V: OcpDiscriminate + VariableLenPack>(
        &mut self,
        value: &V,
        repetition_number: usize,
    ) -> Result<(), ProgramError> {
    ...
    pub fn pack_first_variable_len_value<V: OcpDiscriminate + VariableLenPack>(
        &mut self,
        value: &V,
    ) -> Result<(), ProgramError> {
    ...
    /// Allocate the given number of bytes for the given OcpDiscriminate
    pub fn alloc<V: OcpDiscriminate>(
        &mut self,
        length: usize,
        allow_repetition: bool,
        ...
        if discriminator == ArrayDiscriminator::UNINITIALIZED {
            ...
            discriminator_ref.copy_from_slice(V::OCP_DISCRIMINATOR.as_ref());
            // write length
            let length_ref =
    ...
    pub fn alloc_and_pack_variable_len_entry<V: OcpDiscriminate + VariableLenPack>(
        &mut self,
        value: &V,
        allow_repetition: bool,
    ...
    /// Reallocate the given number of bytes for the given OcpDiscriminate. If
    ...
    pub fn realloc_with_repetition<V: OcpDiscriminate>(
        &mut self,
        length: usize,
        repetition_number: usize,
    ) -> Result<&mut [u8], ProgramError> {
    ...
    /// Reallocate the given number of bytes for the given OcpDiscriminate,
    /// where no repeating discriminators are allowed
    pub fn realloc_first<V: OcpDiscriminate>(
        &mut self,
        length: usize,
    ) -> Result<&mut [u8], ProgramError> {
...
pub fn realloc_and_pack_variable_len_with_repetition<V: OcpDiscriminate + VariableLenPack>(
    ...
    let previous_length = {
        ...
        let TlvIndices {
            ...
            value_start,
            value_repetition_number: _,
        } = get_indices(&data, V::OCP_DISCRIMINATOR, false, Some(repetition_number))?;
...
pub fn realloc_and_pack_first_variable_len<V: OcpDiscriminate + VariableLenPack>(
    account_info: &AccountInfo,
    value: &V,
) -> Result<(), ProgramError> {
...
mod test {
    ...
    impl OcpDiscriminate for TestValue {
        const OCP_DISCRIMINATOR: ArrayDiscriminator =
    ...
    impl OcpDiscriminate for TestSmallValue {
        const OCP_DISCRIMINATOR: ArrayDiscriminator =
    ...
    impl OcpDiscriminate for TestEmptyValue {
        const OCP_DISCRIMINATOR: ArrayDiscriminator =
    ...
    impl OcpDiscriminate for TestNonZeroDefault {
        const OCP_DISCRIMINATOR: ArrayDiscriminator =
    ...
    fn value_pack_unpack() {
        ...
        // check raw buffer
        let mut expect = vec![];
        expect.extend_from_slice(TestValue::OCP_DISCRIMINATOR.as_ref());
        ...
        assert_eq!(
            ...
            &[
                TestValue::OCP_DISCRIMINATOR,
                TestSmallValue::OCP_DISCRIMINATOR
            ]
        );
        ...
        expect.extend_from_slice(&u32::try_from(size_of::<TestValue>()).unwrap().to_le_bytes());
        expect.extend_from_slice(&new_data);
        expect.extend_from_slice(TestSmallValue::OCP_DISCRIMINATOR.as_ref());
    ...
    fn init_buffer_too_small() {
        ...
        discriminator_ref.copy_from_slice(TestValue::OCP_DISCRIMINATOR.as_ref());
    ...
    impl OcpDiscriminate for TestVariableLen {
        const OCP_DISCRIMINATOR: ArrayDiscriminator =
