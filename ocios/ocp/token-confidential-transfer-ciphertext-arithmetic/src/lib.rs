...
fn ristretto_to_elgamal_ciphertext(
    ...
    // Unfortunately, the `bovey-zk-sdk` does not exporse a constructor interface
...
mod tests {
    use {
        ...
        bovey_zk_sdk::encryption::{
            elgamal::{ElGamalCiphertext, ElGamalKeypair},
            pedersen::{Pedersen, PedersenOpening},
            pod::{elgamal::PodDecryptHandle, pedersen::PodPedersenCommitment},
        },
        ocp_token_confidential_transfer_proof_generation::try_split_u64,
    };
