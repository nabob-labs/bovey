...
use bovey_program::{entrypoint::ProgramResult, program_error::ProgramError, pubkey::Pubkey};
...
bovey_program::declare_id!("TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA");

/// Checks that the supplied program ID is the correct one for OCP-token
