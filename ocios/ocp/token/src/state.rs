...
pub struct Account {
    ...
    /// the value is used by the Processor to ensure that wrapped BOV
...
impl Account {
    ...
    pub fn is_owned_by_system_program_or_incinerator(&self) -> bool {
        bovey_program::system_program::check_id(&self.owner)
            || bovey_program::incinerator::check_id(&self.owner)
    }
}
