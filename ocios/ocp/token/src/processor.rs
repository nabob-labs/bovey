...
impl Processor {
    ...
    pub fn process_initialize_immutable_owner(accounts: &[AccountInfo]) -> ProgramResult {
        ...
        msg!("Please upgrade to OCP Token 2022 for immutable owner support");
        Ok(())
    }
    ...
    pub fn cmp_pubkeys(a: &Pubkey, b: &Pubkey) -> bool {
        bov_memcmp(a.as_ref(), b.as_ref(), PUBKEY_BYTES) == 0
    }
...
mod tests {
    ...
    fn test_burn_and_close_system_and_incinerator_tokens() {
        ...
        let mut incinerator_account = BoveyAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            &program_id,
        );
        let system_account_key = Pubkey::new_unique();
        let mut system_account = BoveyAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            &program_id,
        );
        ...
        let mut recipient_account = BoveyAccount::default();
        let mut mock_incinerator_account = BoveyAccount::default();
        let mint_key = Pubkey::new_unique();
        let mut mint_account =
            BoveyAccount::new(mint_minimum_balance(), Mint::get_packed_len(), &program_id);
        ...
        do_process_instruction(
            initialize_account3(
                ...
                &system_account_key,
                &mint_key,
                &bovey_program::system_program::id(),
            )
            .unwrap(),
