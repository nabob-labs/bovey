...
use ocp_token_confidential_transfer_proof_generation::errors::TokenProofGenerationError;
use {
    ...
    ocp_token_confidential_transfer_proof_extraction::errors::TokenProofExtractionError,
    thiserror::Error,
};
