...
use {
    ...
    ocp_token_group_interface::instruction::TokenGroupInstruction,
    ocp_token_metadata_interface::instruction::TokenMetadataInstruction,
...
impl Processor {
    ...
    pub fn process_transfer(
        ...
        if let Some(program_id) = maybe_transfer_hook_program_id {
            if let Some((mint_info, _)) = expected_mint_info {
                ...
                ocp_transfer_hook_interface::onchain::invoke_execute(
                    &program_id,
    ...
    pub fn process_close_account(program_id: &Pubkey, accounts: &[AccountInfo]) -> ProgramResult {
            ...
            PodStateWithExtensions::<PodAccount>::unpack(&source_account_data)
        {
            ...
            } else if !bovey_program::incinerator::check_id(destination_account_info.key) {
                return Err(ProgramError::InvalidAccountData);
            }
...
fn delete_account(account_info: &AccountInfo) -> Result<(), ProgramError> {
    ...
    bovey_program::program_memory::bov_memset(*account_data, 0, data_len);
    Ok(())
}
...
mod tests {
    use {
        ...
        bovey_sdk::account::{
            create_account_for_test, create_is_signer_account_infos, Account as BoveyAccount,
        },
        std::sync::{Arc, RwLock},
    };
    ...
    struct SyscallStubs {}
    impl bovey_sdk::program_stubs::SyscallStubs for SyscallStubs {
        fn bov_log(&self, _message: &str) {}
        ...
        fn bov_get_clock_sysvar(&self, var_addr: *mut u8) -> u64 {
            unsafe {
                *(var_addr as *mut _ as *mut Clock) = Clock::default();
            }
            bovey_program::entrypoint::SUCCESS
        }
        ...
        fn bov_get_rent_sysvar(&self, var_addr: *mut u8) -> u64 {
            unsafe {
        ...
        fn bov_set_return_data(&self, data: &[u8]) {
    ...
    fn do_process_instruction(
    ...
    ) -> ProgramResult {
        {
            ...
            ONCE.call_once(|| {
                bovey_sdk::program_stubs::set_syscall_stubs(Box::new(SyscallStubs {}));
            });
        }
    ...
    fn native_mint() -> BoveyAccount {
        let mut rent_sysvar = rent_sysvar();
        let mut mint_account =
            BoveyAccount::new(mint_minimum_balance(), Mint::get_packed_len(), &crate::id());
    ...
    fn test_initialize_mint() {
        ...
        let mut mint_account = BoveyAccount::new(42, Mint::get_packed_len(), &program_id);
        let mint2_key = Pubkey::new_unique();
        let mut mint2_account =
            BoveyAccount::new(mint_minimum_balance(), Mint::get_packed_len(), &program_id);
        let mut rent_sysvar = rent_sysvar();
    ...
    fn test_initialize_mint_account() {
        ...
        let mut account_account = BoveyAccount::new(42, Account::get_packed_len(), &program_id);
        let owner_key = Pubkey::new_unique();
        let mut owner_account = BoveyAccount::default();
        let mint_key = Pubkey::new_unique();
        let mut mint_account =
            BoveyAccount::new(mint_minimum_balance(), Mint::get_packed_len(), &program_id);
        let mut rent_sysvar = rent_sysvar();
    ...
    fn test_transfer_dups() {
        ...
        let mut account1_account = BoveyAccount::new(
        ...
        let mut account2_account = BoveyAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            &program_id,
        );
        ...
        let mut account3_account = BoveyAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            &program_id,
        );
        ...
        let mut account4_account = BoveyAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            &program_id,
        );
        ...
        let mut multisig_account = BoveyAccount::new(
    ...
    fn test_transfer() {
        let program_id = crate::id();
        let account_key = Pubkey::new_unique();
        let mut account_account = BoveyAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            &program_id,
        );
        ...
        let mut delegate_account = BoveyAccount::default();
        let mismatch_key = Pubkey::new_unique();
        let mut mismatch_account = BoveyAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            &program_id,
        );
        ...
        let mut owner2_account = BoveyAccount::default();
        let mint_key = Pubkey::new_unique();
        let mut mint_account =
            BoveyAccount::new(mint_minimum_balance(), Mint::get_packed_len(), &program_id);
        let mint2_key = Pubkey::new_unique();
    ...
    fn test_set_authority() {
        ...
        let mut owner3_account = BoveyAccount::default();
        let mint_key = Pubkey::new_unique();
        let mut mint_account =
            BoveyAccount::new(mint_minimum_balance(), Mint::get_packed_len(), &program_id);
        let mint2_key = Pubkey::new_unique();
    ...
    fn test_mint_to() {
        ...
        let mut uninitialized_account = BoveyAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            &program_id,
        );
    ...
    fn test_multisig() {
        ...
        let mut mint_account =
            BoveyAccount::new(mint_minimum_balance(), Mint::get_packed_len(), &program_id);
        let account_key = Pubkey::new_unique();
        let mut account = BoveyAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            &program_id,
        );
        ...
        let mut owner_account = BoveyAccount::default();
        let multisig_key = Pubkey::new_unique();
        let mut multisig_account = BoveyAccount::new(42, Multisig::get_packed_len(), &program_id);
        let multisig_delegate_key = Pubkey::new_unique();
        let mut multisig_delegate_account = BoveyAccount::new(
            multisig_minimum_balance(),
            Multisig::get_packed_len(),
            &program_id,
        );
        ...
        let mut signer_accounts = vec![BoveyAccount::new(0, 0, &program_id); MAX_SIGNERS];
        let mut rent_sysvar = rent_sysvar();
    ...
    fn test_owner_close_account_dups() {
        ...
        let mut to_close_account = BoveyAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            &program_id,
        );
        ...
        let mut destination_account = BoveyAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            &program_id,
        );
    ...
    fn test_close_account() {
        ...
        let owner2_key = Pubkey::new_unique();
        let mut owner2_account = BoveyAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            &program_id,
        );
    ...
    fn test_native_token() {
        ...
        let account3_key = Pubkey::new_unique();
        let mut account3_account = BoveyAccount::new(account_minimum_balance(), 0, &program_id);
        let owner_key = Pubkey::new_unique();
        let mut owner_account = BoveyAccount::default();
        let owner2_key = Pubkey::new_unique();
        let mut owner2_account = BoveyAccount::default();
    ...
    fn test_overflow() {
        ...
        let mut mint_owner_account = BoveyAccount::default();
        let mint_key = Pubkey::new_unique();
        let mut mint_account =
            BoveyAccount::new(mint_minimum_balance(), Mint::get_packed_len(), &program_id);
        let mut rent_sysvar = rent_sysvar();
    ...
    fn test_freeze_account() {
        ...
        let mut account_owner_account = BoveyAccount::default();
        let owner_key = Pubkey::new_unique();
        let mut owner_account = BoveyAccount::default();
        let owner2_key = Pubkey::new_unique();
        let mut owner2_account = BoveyAccount::default();
    ...
    fn initialize_account_on_non_transferable_mint() {
        ...
        .unwrap();
        let mut account_without_enough_length = BoveyAccount::new(
            Rent::default().minimum_balance(account_len),
            account_len,
            &program_id,
        );
        ...
        .unwrap();
        let mut account_with_enough_length = BoveyAccount::new(
        ...
        let mint_len =
            ExtensionType::try_calculate_account_len::<Mint>(&[ExtensionType::NonTransferable])
                .unwrap();
        let mut mint_account = BoveyAccount::new(
    ...
    fn test_sync_native() {
        ...
        let lamports = 40;
        let mut native_account = BoveyAccount::new(
            account_minimum_balance() + lamports,
            Account::get_packed_len(),
            &program_id,
        );
        let non_native_account_key = Pubkey::new_unique();
        let mut non_native_account = BoveyAccount::new(
    ...
    fn test_get_account_data_size() {
        ...
        let mint_len =
            ExtensionType::try_calculate_account_len::<Mint>(&[ExtensionType::TransferFeeConfig])
                .unwrap();
        let mut extended_mint_account = BoveyAccount::new(
            Rent::default().minimum_balance(mint_len),
            mint_len,
            &program_id,
        );
        ...
        // Invalid mint
        let mut invalid_mint_account = BoveyAccount::new(
            account_minimum_balance(),
            Account::get_packed_len(),
            &program_id,
        );
    ...
    fn test_withdraw_excess_lamports_from_multisig() {
        ...
        let multisig_key = Pubkey::new_unique();
        let mut multisig_account = BoveyAccount::new(0, Multisig::get_packed_len(), &program_id);
