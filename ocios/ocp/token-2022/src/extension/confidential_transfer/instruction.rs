pub use bovey_zk_sdk::zk_elgamal_proof_program::{
...
use {
    ...
    ocp_token_confidential_transfer_proof_extraction::instruction::{ProofData, ProofLocation},
};
...
pub enum ConfidentialTransferInstruction {
    ...
    ///   0. `[writeable]` The OCP Token account.
    ///   1. `[]` The corresponding OCP Token mint.
    ...
    ///   5. .. `[signer]` Required M signer accounts for the OCP Token Multisig
    ///      account.
    ///
    /// Data expected by this instruction:
    ...
    /// OCP Token mint.  This instruction must be executed after the account
    /// owner configures their account for confidential transfers with
    /// `ConfidentialTransferInstruction::ConfigureAccount`.
    ///
    /// Accounts expected by this instruction:
    ///
    ///   0. `[writable]` The OCP Token account to approve.
    ///   1. `[]` The OCP Token mint.
    ...
    ///
    ///   * Single owner/delegate
    ///   0. `[writable]` The OCP Token account.
    ...
    ///   4. .. `[signer]` Required M signer accounts for the OCP Token Multisig
    ///      account.
    ///
    /// Data expected by this instruction:
    ...
    /// Deposit OCP Tokens into the pending balance of a confidential token
    /// account.
    ///
    ...
    ///   3. .. `[signer]` Required M signer accounts for the OCP Token Multisig
    ///      account.
    ///
    /// Data expected by this instruction:
    ...
    /// Withdraw OCP Tokens from the available balance of a confidential token
    /// account.
    ///
    /// In order for this instruction to be successfully processed, it must be
    ...
    ///   6. .. `[signer]` Required M signer accounts for the OCP Token Multisig
    ///      account.
    ///
    /// Data expected by this instruction:
    ...
    ///
    ///   * Single owner/delegate
    ///   1. `[writable]` The source OCP Token account.
    ///   2. `[]` The token mint.
    ///   3. `[writable]` The destination OCP Token account.
    ...
    ///   9. .. `[signer]` Required M signer accounts for the OCP Token Multisig
    ///      account.
    ///
    /// Data expected by this instruction:
    ...
    ///   2. .. `[signer]` Required M signer accounts for the OCP Token Multisig
    ///      account.
    ///
    /// Data expected by this instruction:
    ...
    ///   11. .. `[signer]` Required M signer accounts for the OCP Token
    ///       Multisig
    ///
    /// Data expected by this instruction:
