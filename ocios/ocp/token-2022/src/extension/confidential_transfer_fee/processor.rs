...
#[cfg(feature = "zk-ops")]
use ocp_token_confidential_transfer_ciphertext_arithmetic as ciphertext_arithmetic;
use {
    crate::{
    ...
    ocp_token_confidential_transfer_proof_extraction::instruction::verify_and_extract_context,
};
