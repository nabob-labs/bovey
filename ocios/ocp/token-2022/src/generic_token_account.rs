//! Generic Token Account, copied from `ocp_token::state`
// Remove all of this and use ocp-token's version once token 3.4.0 is released
use {
    crate::state::AccountState,
    bovey_program::pubkey::{Pubkey, PUBKEY_BYTES},
};

const OCP_TOKEN_ACCOUNT_MINT_OFFSET: usize = 0;
const OCP_TOKEN_ACCOUNT_OWNER_OFFSET: usize = 32;
