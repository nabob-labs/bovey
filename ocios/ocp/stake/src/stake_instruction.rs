use {
    ...
    bovey_pubkey::Pubkey,
    bovey_stake_interface::{
        error::StakeError,
        instruction::{LockupArgs, StakeInstruction},
        program::id,
        state::{Authorized, Lockup},
    },
    bovey_transaction_context::{IndexOfAccount, InstructionContext, TransactionContext},
};
...
declare_process_instruction!(Entrypoint, DEFAULT_COMPUTE_UNITS, |invoke_context| {
    ...
    let stake_instruction: StakeInstruction =
        limited_deserialize(data, bovey_packet::PACKET_DATA_SIZE as u64)?;
    ...
    match stake_instruction {
        ...
        StakeInstruction::MoveStake(lamports) => {
            if invoke_context
                .get_feature_set()
                .is_active(&bovey_feature_set::move_stake_and_move_lamports_ixs::id())
            {
                instruction_context.check_number_of_instruction_accounts(3)?;
                move_stake(
                    invoke_context,
...
mod tests {
    use {
        ...
        bovey_clock::{Clock, Epoch, UnixTimestamp},
        ...
        bovey_program_runtime::invoke_context::mock_process_instruction,
        bovey_pubkey::Pubkey,
        bovey_rent::Rent,
        bovey_sdk_ids::{
            system_program,
        ...
        bovey_vote_interface::state::{VoteState, VoteStateVersions},
        ocp_vote_program::vote_state,
    ...
    fn feature_set_no_minimum_delegation() -> Arc<FeatureSet> {
        ...
        Arc::get_mut(&mut feature_set)
            .unwrap()
            .deactivate(&bovey_feature_set::stake_raise_minimum_delegation_to_1_bov::id());
        feature_set
    }
                ...
                (
                    *pubkey,
                    if clock::check_id(pubkey) {
                        ...
                        AccountSharedData::new(0, 0, &bovey_sdk_ids::vote::id())
    ...
    fn test_stake_process_instruction_decode_bail(feature_set: Arc<FeatureSet>) {
        ...
        let vote_account = AccountSharedData::new(0, 0, &bovey_sdk_ids::vote::id());
    ...
    fn test_stake_initialize(feature_set: Arc<FeatureSet>) {
        ...
        let stake_address = bovey_pubkey::new_rand();
        let stake_account = AccountSharedData::new(stake_lamports, StakeStateV2::size_of(), &id());
        let custodian_address = bovey_pubkey::new_rand();
        let lockup = Lockup {
            epoch: 1,
            unix_timestamp: 0,
    ...
    fn test_authorize(feature_set: Arc<FeatureSet>) {
        let authority_address = bovey_pubkey::new_rand();
        let authority_address_2 = bovey_pubkey::new_rand();
        let stake_address = bovey_pubkey::new_rand();
        ...
        .unwrap();
        let to_address = bovey_pubkey::new_rand();
    ...
    fn test_authorize_override(feature_set: Arc<FeatureSet>) {
        let authority_address = bovey_pubkey::new_rand();
        let mallory_address = bovey_pubkey::new_rand();
        let stake_address = bovey_pubkey::new_rand();
        let stake_lamports = 42;
        let stake_account = AccountSharedData::new_data_with_space(
            stake_lamports,
    ...
    fn test_authorize_with_seed(feature_set: Arc<FeatureSet>) {
        let authority_base_address = bovey_pubkey::new_rand();
        let authority_address = bovey_pubkey::new_rand();
        let seed = "42";
    ...
    fn test_authorize_delegated_stake(feature_set: Arc<FeatureSet>) {
        ...
        .unwrap();
        let vote_address = bovey_pubkey::new_rand();
        let vote_account =
            vote_state::create_account(&vote_address, &bovey_pubkey::new_rand(), 0, 100);
        let vote_address_2 = bovey_pubkey::new_rand();
        let mut vote_account_2 =
            vote_state::create_account(&vote_address_2, &bovey_pubkey::new_rand(), 0, 100);
    ...
    fn test_stake_delegate(feature_set: Arc<FeatureSet>) {
        ...
        transaction_accounts[1]
            .1
            .set_owner(bovey_pubkey::new_rand());
        process_instruction(
            Arc::clone(&feature_set),
            &serialize(&StakeInstruction::DelegateStake).unwrap(),
            transaction_accounts.clone(),
            instruction_accounts.clone(),
            Err(bovey_instruction::error::InstructionError::IncorrectProgramId),
        );
    ...
    fn test_redelegate_consider_balance_changes(feature_set: Arc<FeatureSet>) {
        ...
        let recipient_address = bovey_pubkey::new_rand();
        let authority_address = bovey_pubkey::new_rand();
        let vote_address = bovey_pubkey::new_rand();
        let vote_account =
            vote_state::create_account(&vote_address, &bovey_pubkey::new_rand(), 0, 100);
    ...
    fn test_split(feature_set: Arc<FeatureSet>) {
        ...
        let split_to_address = bovey_pubkey::new_rand();
    ...
    fn test_set_lockup(feature_set: Arc<FeatureSet>) {
        let custodian_address = bovey_pubkey::new_rand();
        let authorized_address = bovey_pubkey::new_rand();
        let stake_address = bovey_pubkey::new_rand();
        let minimum_delegation = crate::get_minimum_delegation(&feature_set);
        let stake_lamports = minimum_delegation;
        let stake_account = AccountSharedData::new_data_with_space(
    ...
    fn test_merge(feature_set: Arc<FeatureSet>) {
        let stake_address = bovey_pubkey::new_rand();
        let merge_from_address = bovey_pubkey::new_rand();
        let authorized_address = bovey_pubkey::new_rand();
    ...
    fn test_merge_incorrect_authorized_staker(feature_set: Arc<FeatureSet>) {
        ...
        let merge_from_address = bovey_pubkey::new_rand();
        let authorized_address = bovey_pubkey::new_rand();
        let wrong_authorized_address = bovey_pubkey::new_rand();
        let stake_lamports = 42;
        let mut instruction_accounts = vec![
            AccountMeta {
                pubkey: stake_address,
