use {
    ...
    bovey_bpf::{error::EbpfError, memory_region::MemoryRegion},
    std::slice,
};
...
declare_builtin_function!(
    ...
    fn rust(
        ...
        if invoke_context
            .get_feature_set()
            .is_active(&bovey_feature_set::bpf_account_data_direct_mapping::id())
        {
...
mod tests {
    use {
        ...
        bovey_bpf::{ebpf::MM_RODATA_START, program::SBPFVersion},
        test_case::test_case,
    };
