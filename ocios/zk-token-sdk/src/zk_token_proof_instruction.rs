...
//!
//! [`ZK Token proof`]: https://docs.boveylabs.com/runtime/zk-token-proof
//! [`context-state`]: https://docs.boveylabs.com/runtime/zk-token-proof#context-data
...
pub enum ProofInstruction {
    ...
    ///
    /// This proof is a collection of smaller proofs that are required by the OCP Token 2022
    ...
    ///
    /// A fee sigma proof certifies that a Pedersen commitment that encodes a transfer fee for OCP
