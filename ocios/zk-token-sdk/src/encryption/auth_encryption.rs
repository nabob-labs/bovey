...
//!
//! This module is a simple wrapper of the `Aes128GcmSiv` implementation specialized for OCP
...
use {
    ...
    bovey_signer::{EncodableKey, Signer, SignerError},
    std::{
        convert::TryInto,
        error, fmt,
        io::{Read, Write},
...
impl AeKey {
    /// Deterministically derives an authenticated encryption key from a Bovey signer and a public
    /// seed.
    ///
    ...
    /// Derive a seed from a Bovey signer used to generate an authenticated encryption key.
    ///
...
/// For the purpose of encrypting balances for the ocp token accounts, the nonce and ciphertext
...
mod tests {
    use {
        super::*, bovey_keypair::Keypair, bovey_pubkey::Pubkey,
