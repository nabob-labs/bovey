use {
    crate::compute_budget_instruction_details::*, bovey_compute_budget::compute_budget_limits::*,
    bovey_feature_set::FeatureSet, bovey_pubkey::Pubkey,
...
mod tests {
    ...
    macro_rules! test {
        ...
        ( $instructions: expr, $expected_result: expr, $feature_set: expr) => {
            ...
            let result = process_compute_budget_instructions(
                VMMessage::program_instructions_iter(&tx),
                $feature_set,
            );
    ...
    fn test_process_mixed_instructions_without_compute_budget() {
        ...
        for (feature_set, expected_result) in [
            ...
            let result = process_compute_budget_instructions(
                VMMessage::program_instructions_iter(&transaction),
                &feature_set,
            );
