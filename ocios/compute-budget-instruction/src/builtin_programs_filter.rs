...
mod test {
    use {
        super::*, bovey_builtins_default_costs::get_migration_feature_position,
    ...
    fn get_program_kind() {
        ...
        // again
        assert_eq!(
            test_store.get_program_kind(index, &bovey_sdk_ids::loader_v4::id()),
            ProgramKind::NotBuiltin
        );
        ...
        index += 1;
        assert_eq!(
            test_store.get_program_kind(index, &bovey_sdk_ids::compute_budget::id()),
            ProgramKind::Builtin,
        );
