...
//!
//! The design principle of this crate (`bovey-unified-scheduler-logic`) is simplicity for the
//! separation of concern. It is interacted only with a few of its public API by
//! `bovey-unified-scheduler-pool`. This crate doesn't know about banks, slots, bovey-runtime,
...
mod utils {
    ...
    mod tests {
        ...
        #[test]
        #[should_panic(
            expected = "\"bovey_unified_scheduler_logic::utils::Token<usize>\" is wrongly \
...
/// Scheduler's internal data for each address ([`Pubkey`](`bovey_sdk::pubkey::Pubkey`)). Very
