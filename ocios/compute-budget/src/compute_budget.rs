...
impl ::bovey_frozen_abi::abi_example::AbiExample for ComputeBudget {
    fn example() -> Self {
...
pub struct ComputeBudget {
    ...
    /// program heap region size, default: bovey_sdk::entrypoint::HEAP_LENGTH
    pub heap_size: u32,
...
impl ComputeBudget {
    ...
    fn new(compute_unit_limit: u64) -> Self {
        ComputeBudget {
            ...
            heap_size: u32::try_from(bovey_program_entrypoint::HEAP_LENGTH).unwrap(),
