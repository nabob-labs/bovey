use {
    ...
    bovey_instructions_sysvar as instructions,
    bovey_measure::measure_us,
    bovey_precompiles::get_precompile,
...
mod tests {
    use {
        ...
        bovey_ed25519_program::new_ed25519_instruction,
        bovey_feature_set::FeatureSet,
        bovey_hash::Hash,
        bovey_instruction::{error::InstructionError, AccountMeta, Instruction},
        bovey_message::{AccountKeys, Message, SanitizedMessage},
        ...
        bovey_sdk::native_loader::create_loadable_account_for_test,
        bovey_sdk_ids::{ed25519_program, native_loader, secp256k1_program, system_program},
        bovey_secp256k1_program::new_secp256k1_instruction,
        bovey_secp256r1_program::new_secp256r1_instruction,
    ...
    fn test_precompile() {
        ...
        let accounts = vec![
            ...
            (bovey_secp256r1_program::id(), secp256r1_account),
