#[allow(deprecated)]
use bovey_sysvar::{fees::Fees, recent_blockhashes::RecentBlockhashes};
use {
    ...
    bovey_sysvar::{stake_history::StakeHistory, Sysvar},
...
impl ::bovey_frozen_abi::abi_example::AbiExample for SysvarCache {
    fn example() -> Self {
...
/// as `bovey_sdk::keyed_account::from_keyed_account` despite dynamically
