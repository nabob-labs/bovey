...
///
/// ```
/// use bovey_nohash_hasher::IntMap;
///
...
///
/// ```
/// use bovey_nohash_hasher::IntSet;
///
...
///
/// ```
/// use bovey_nohash_hasher::BuildNoHashHasher;
...
///
/// ```
/// use bovey_nohash_hasher::NoHashHasher;
...
/// }
///
/// impl bovey_nohash_hasher::IsEnabled for SomeType {}
///
/// let mut m = bovey_nohash_hasher::IntMap::default();
///
