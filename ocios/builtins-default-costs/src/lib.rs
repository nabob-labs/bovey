...
lazy_static! {
    ...
    /// limit for transactions that don't specify a compute limit themselves
...
const MIGRATING_BUILTINS_COSTS: &[(Pubkey, BuiltinCost)] = &[
    (
        stake::id(),
        BuiltinCost::Migrating(MigratingBuiltinCost {
            native_cost: ocp_stake_program::stake_instruction::DEFAULT_COMPUTE_UNITS,
    ...
    (
        config::id(),
        BuiltinCost::Migrating(MigratingBuiltinCost {
            native_cost: ocp_config_program::config_processor::DEFAULT_COMPUTE_UNITS,
    ...
    (
        ...
        BuiltinCost::Migrating(MigratingBuiltinCost {
            native_cost: ocp_address_lookup_table_program::processor::DEFAULT_COMPUTE_UNITS,
            core_bpf_migration_feature:
...
const NON_MIGRATING_BUILTINS_COSTS: &[(Pubkey, BuiltinCost)] = &[
    (
        ...
        BuiltinCost::NotMigrating(NotMigratingBuiltinCost {
            native_cost: ocp_vote_program::vote_processor::DEFAULT_COMPUTE_UNITS,
        }),
    ),
    (
        system_program::id(),
        BuiltinCost::NotMigrating(NotMigratingBuiltinCost {
            native_cost: ocp_system_program::system_processor::DEFAULT_COMPUTE_UNITS,
        }),
    ),
    (
        compute_budget::id(),
        BuiltinCost::NotMigrating(NotMigratingBuiltinCost {
            native_cost: ocp_compute_budget_program::DEFAULT_COMPUTE_UNITS,
        }),
    ),
    (
        bpf_loader_upgradeable::id(),
        BuiltinCost::NotMigrating(NotMigratingBuiltinCost {
            native_cost: ocp_bpf_loader_program::UPGRADEABLE_LOADER_COMPUTE_UNITS,
        }),
    ),
    (
        bpf_loader_deprecated::id(),
        BuiltinCost::NotMigrating(NotMigratingBuiltinCost {
            native_cost: ocp_bpf_loader_program::DEPRECATED_LOADER_COMPUTE_UNITS,
        }),
    ),
    (
        bpf_loader::id(),
        BuiltinCost::NotMigrating(NotMigratingBuiltinCost {
            native_cost: ocp_bpf_loader_program::DEFAULT_LOADER_COMPUTE_UNITS,
        }),
    ),
    (
        loader_v4::id(),
        BuiltinCost::NotMigrating(NotMigratingBuiltinCost {
            native_cost: ocp_loader_v4_program::DEFAULT_COMPUTE_UNITS,
        }),
    ),
...
mod test {
    ...
    fn test_get_builtin_instruction_cost() {
        ...
        assert_eq!(
            Some(ocp_compute_budget_program::DEFAULT_COMPUTE_UNITS),
        ...
        assert_eq!(
            Some(ocp_stake_program::stake_instruction::DEFAULT_COMPUTE_UNITS),
