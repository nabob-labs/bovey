...
mod target_arch {
    ...
    pub fn validate_edwards(point: &PodEdwardsPoint) -> bool {
        ...
        let result = unsafe {
            bovey_define_syscall::definitions::bov_curve_validate_point(
                CURVE25519_EDWARDS,
                &point.0 as *const u8,
                &mut validate_result,
            )
    ...
    pub fn add_edwards(
        ...
        let result = unsafe {
            bovey_define_syscall::definitions::bov_curve_group_op(
                CURVE25519_EDWARDS,
                ADD,
    ...
    pub fn multiscalar_multiply_edwards(
        ...
        let mut result_point = PodEdwardsPoint::zeroed();
        let result = unsafe {
            bovey_define_syscall::definitions::bov_curve_multiscalar_mul(
                CURVE25519_EDWARDS,
