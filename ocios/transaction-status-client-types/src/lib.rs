//! Core types for bovey-transaction-status
use {
    ...
    serde_json::Value,
    bovey_account_decoder_client_types::token::UiTokenAmount,
...
pub struct UiTransactionStatusMeta {
    pub err: Option<TransactionError>,
    pub status: TransactionResult<()>, // This field is deprecated.
    pub fee: u64,
