use {
    ...
    dashmap::DashMap,
    log::*,
    bovey_account::{AccountSharedData, ReadableAccount},
    bovey_address_lookup_table_interface::{
        self as address_lookup_table, error::AddressLookupError, state::AddressLookupTable,
    },
    bovey_clock::{BankId, Slot},
    bovey_message::v0::LoadedAddresses,
    bovey_pubkey::Pubkey,
    bovey_slot_hashes::SlotHashes,
    bovey_vm_transaction::{
        message_address_table_lookup::VMMessageAddressTableLookup, vm_message::VMMessage,
    },
    bovey_transaction::sanitized::SanitizedTransaction,
    bovey_transaction_context::TransactionAccount,
    bovey_transaction_error::TransactionResult as Result,
    std::{
        cmp::Reverse,
...
struct TransactionAccountLocksIterator<'a, T: VMMessage> {
    transaction: &'a T,
}

impl<'a, T: VMMessage> TransactionAccountLocksIterator<'a, T> {
...
impl Accounts {
    ...
    pub fn load_lookup_table_addresses(
        &self,
        ancestors: &Ancestors,
        address_table_lookup: VMMessageAddressTableLookup,
    ...
    /// same time
    #[must_use]
    pub fn lock_accounts<'a, Tx: VMMessage + 'a>(
        &self,
    ...
    pub fn lock_accounts_with_results<'a>(
        &self,
        txs: impl Iterator<Item = &'a (impl VMMessage + 'a)>,
    ...
    fn lock_accounts_inner(
        &self,
        tx_account_locks_results: Vec<Result<TransactionAccountLocksIterator<impl VMMessage>>>,
    ) -> Vec<Result<()>> {
...
mod tests {
    use {
        ...
        bovey_address_lookup_table_interface::state::LookupTableMeta,
        bovey_hash::Hash,
        ...
        bovey_sdk_ids::native_loader,
        bovey_signer::{signers::Signers, Signer},
        bovey_transaction::{sanitized::MAX_TX_ACCOUNT_LOCKS, Transaction},
    ...
    fn test_load_lookup_table_addresses_account_not_found() {
        ...
        assert_eq!(
            accounts.load_lookup_table_addresses(
                &ancestors,
                VMMessageAddressTableLookup::from(&address_table_lookup),
                &SlotHashes::default(),
            ),
