#[allow(deprecated)]
use bovey_sysvar::recent_blockhashes;
use {
    serde::{Deserialize, Serialize},
    bovey_clock::MAX_RECENT_BLOCKHASHES,
...
impl BlockhashQueue {
    ...
    #[deprecated(
        since = "2.0.0",
        note = "Please use `bovey_program::clock::MAX_PROCESSING_AGE`"
    )]
...
mod tests {
    ...
    use {
        super::*, bincode::serialize, bovey_clock::MAX_RECENT_BLOCKHASHES,
