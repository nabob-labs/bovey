...
use {
    rand::Rng, bovey_account::WritableAccount, bovey_keypair::Keypair, bovey_rent::Rent,
    bovey_signer::Signer, ocp_stake_program::stake_state, ocp_vote_program::vote_state,
};
    ...
    pub fn new_random() -> Self {
        ...
        Self {
            ...
            stake_reward_info: RewardInfo {
                reward_type: bovey_reward_info::RewardType::Staking,
