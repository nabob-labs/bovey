//! Implementation of `VMRentCollector` for `RentCollector` from the Bovey
//! SDK.

use {
    crate::vm_rent_collector::VMRentCollector,
    bovey_sdk::{
...
impl VMRentCollector for RentCollector {
